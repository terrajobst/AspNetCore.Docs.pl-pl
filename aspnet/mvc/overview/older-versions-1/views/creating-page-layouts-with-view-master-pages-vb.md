...
---
<a name="creating-page-layouts-with-view-master-pages-vb"></a>Tworzenie układów strony za pomocą stron wzorcowych widoku (VB)
====================
...
**Rysunek 01**: Dodawanie strony wzorcowej widoku ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](creating-page-layouts-with-view-master-pages-vb/_static/image3.png))
...
**Rysunek 03**: Dodawanie strony zawartości widoku ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](creating-page-layouts-with-view-master-pages-vb/_static/image9.png))
...
**Rysunek 05**: stronę zawartości widoku indeksu ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](creating-page-layouts-with-view-master-pages-vb/_static/image15.png))
