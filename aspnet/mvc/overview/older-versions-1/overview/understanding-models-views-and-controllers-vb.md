...
---
<a name="understanding-models-views-and-controllers-vb"></a>Opis modele, widoki i kontrolery (VB)
====================
...
[![Tworzenie okna dialogowego testów jednostkowych](understanding-models-views-and-controllers-vb/_static/image2.jpg)](understanding-models-views-and-controllers-vb/_static/image3.png)

**Rysunek 02**: Tworzenie jednostki okno dialogowe testu ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](understanding-models-views-and-controllers-vb/_static/image4.png))
...
**Rysunek 04**: debugowanie nie włączone okna dialogowego ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](understanding-models-views-and-controllers-vb/_static/image8.png))
...
[![Strona indeksu](understanding-models-views-and-controllers-vb/_static/image5.jpg)](understanding-models-views-and-controllers-vb/_static/image9.png)
...
Kontroler to po prostu klasy (na przykład klasy Visual Basic lub C#). Przykładowej aplikacji ASP.NET MVC zawiera kontrolerze o nazwie HomeController.vb znajdujące się w folderze kontrolerów. Zawartość pliku HomeController.vb jest przedstawiony w wyświetlania 2.
