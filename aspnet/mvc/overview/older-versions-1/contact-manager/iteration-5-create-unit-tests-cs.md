...
4. Dodaj odwołanie do zestawu Moq prawym przyciskiem myszy folder odwołań w projekcie ContactManager.Tests i wybierając **Dodaj odwołanie**. Na karcie przeglądania, przejdź do folderu, gdzie można rozpakować Moq i wybierz zestaw Moq.dll. Kliknij przycisk **OK** przycisku.
5. Po wykonaniu tych kroków folderu odwołań powinna wyglądać na rysunku 2.
...
**Rysunek 01**: odblokowywania Moq ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](iteration-5-create-unit-tests-cs/_static/image2.png))
...
Utwórz nowy folder o nazwie modeli w projekcie ContactManager.Tests. Następnie kliknij prawym przyciskiem myszy folder modeli i wybierz **Dodaj, nowego testu**. **Dodaj nowy Test** zostanie wyświetlone okno dialogowe pokazany na rysunku 3. Wybierz **testu jednostkowego** szablonu i nazwy nowego testu ContactManagerServiceTest.cs. Kliknij przycisk **OK** przycisk, aby dodać nowy test do projektu Test.
...
[![Wyniki testu](iteration-5-create-unit-tests-cs/_static/image4.jpg)](iteration-5-create-unit-tests-cs/_static/image7.png)
...
Aplikacja ASP.NETMVC sterowanie przepływem interakcji z użytkownikiem. Podczas testowania kontrolera, chcesz sprawdzić, czy kontroler zwraca dane wynik i widok prawym akcji. Można również sprawdzić, czy kontroler współdziała z klasami modelu w oczekiwany sposób.
