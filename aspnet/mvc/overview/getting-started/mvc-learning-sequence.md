...
- [Wprowadzenie do platformy ASP.NET MVC 5](introduction/getting-started.md) seria części 11 ten jest dobrym miejscem do rozpoczęcia.
- [Podstawowe informacje dotyczące Pluralsight ASP.NET MVC 5](https://pluralsight.com/training/Player?author=scott-allen&amp;name=aspdotnet-mvc5-fundamentals-m1-introduction&amp;mode=live&amp;clip=0&amp;course=aspdotnet-mvc5-fundamentals) (kursu wideo)
- [Wprowadzenie do platformy ASP.NET MVC](https://www.microsoftvirtualacademy.com/training-courses/introduction-to-asp-net-mvc) Galloway Jan i Christopher Harrison
...
- [Wprowadzenie do korzystania z EF 6 Code First przy użyciu MVC 5](getting-started-with-ef-using-mvc/creating-an-entity-framework-data-model-for-an-asp-net-mvc-application.md) Dykstra Tomasz nagrodami serii dives dogłębną analizę EF.
