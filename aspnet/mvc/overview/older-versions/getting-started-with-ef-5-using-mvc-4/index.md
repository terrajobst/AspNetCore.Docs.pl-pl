...
---
<a name="getting-started-with-ef-5-using-mvc-4"></a>Wprowadzenie do 5 EF przy użyciu MVC 4
====================
> Podstawy do wyświetlania i edytowania danych w aplikacji ASP.NET MVC 4 przy użyciu programu Entity Framework 5.
...
- [Implementowanie repozytorium i jednostki pracy](implementing-the-repository-and-unit-of-work-patterns-in-an-asp-net-mvc-application.md)
- [Zaawansowane Entity Framework scenariuszy](advanced-entity-framework-scenarios-for-an-mvc-web-application.md)
- [Tworzenie rozdział pliki do pobrania](building-the-ef5-mvc4-chapter-downloads.md)
