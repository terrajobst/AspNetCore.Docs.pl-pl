...
1. [<span data-ttu-id="2f4b1-139">Tworzenie kontrolera Menedżer magazynu i jego widoku indeksu</span><span class="sxs-lookup"><span data-stu-id="2f4b1-139">Creating the Store Manager controller and its Index view</span></span>](#Exercise1)
...
2. <span data-ttu-id="2f4b1-161">Dodaj nowy kontroler.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-161">Add a new controller.</span></span> <span data-ttu-id="2f4b1-162">Aby to zrobić, kliknij prawym przyciskiem myszy **kontrolerów** folder w Eksploratorze rozwiązań wybierz **Dodaj** , a następnie **kontrolera** polecenia.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-162">To do this, right-click the **Controllers** folder within the Solution Explorer, select **Add** and then the **Controller** command.</span></span> <span data-ttu-id="2f4b1-163">Zmień **kontrolera** **nazwa** do **StoreManagerController** i upewnij się, że opcja **kontroler MVC z akcjami odczytu/zapisu pusty**jest zaznaczone.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-163">Change the **Controller** **Name** to **StoreManagerController** and make sure the option **MVC controller with empty read/write actions** is selected.</span></span> <span data-ttu-id="2f4b1-164">Kliknij przycisk **Dodaj**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-164">Click **Add**.</span></span>
    ...
    <span data-ttu-id="2f4b1-166">*Dodawanie kontrolera okna dialogowego*</span><span class="sxs-lookup"><span data-stu-id="2f4b1-166">*Add Controller Dialog*</span></span>
...
3. <span data-ttu-id="2f4b1-187">W oknie dialogowym Dodaj widok, sprawdź, czy nazwa widoku jest **indeksu**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-187">In the Add View dialog, verify that the View Name is **Index**.</span></span> <span data-ttu-id="2f4b1-188">Wybierz **utworzyć widok jednoznacznie** i wybrać **albumu (MvcMusicStore.Models)** z **klasa modelu** listy rozwijanej.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-188">Select the **Create a strongly-typed view** option, and select **Album (MvcMusicStore.Models)** from the **Model class** drop-down.</span></span> <span data-ttu-id="2f4b1-189">Wybierz **listy** z **szablonu szkieletu** listy rozwijanej.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-189">Select **List** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="2f4b1-190">Pozostaw **aparat widoku** do **Razor** i innych pól z ich domyślną wartość, a następnie kliknij przycisk **Dodaj**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-190">Leave the **View engine** to **Razor** and the other fields with their default value and then click **Add**.</span></span>
    ...
    <span data-ttu-id="2f4b1-192">*Dodawanie widok indeksu*</span><span class="sxs-lookup"><span data-stu-id="2f4b1-192">*Adding an Index View*</span></span>
...
<span data-ttu-id="2f4b1-215">*Nie przeglądania listy albumów z obcięte tekstu*</span><span class="sxs-lookup"><span data-stu-id="2f4b1-215">*Browsing the list of Albums with not truncated text*</span></span>
...
2. <span data-ttu-id="2f4b1-275">W oknie dialogowym Dodaj widok, sprawdź, czy nazwa widoku jest **Edytuj**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-275">In the Add View dialog, verify that the View Name is **Edit**.</span></span> <span data-ttu-id="2f4b1-276">Sprawdź **utworzyć widok jednoznacznie** wyboru i wybierz **albumu (MvcMusicStore.Models)** z **wyświetlić klasy danych** listy rozwijanej.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-276">Check the **Create a strongly-typed view** checkbox and select **Album (MvcMusicStore.Models)** from the **View data class** drop-down.</span></span> <span data-ttu-id="2f4b1-277">Wybierz **Edytuj** z **szablonu szkieletu** listy rozwijanej.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-277">Select **Edit** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="2f4b1-278">Pozostaw innych pól ich wartości domyślne, a następnie kliknij przycisk **Dodaj**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-278">Leave the other fields with their default value and then click **Add**.</span></span>
    ...
    <span data-ttu-id="2f4b1-280">*Dodawanie widoku edycji*</span><span class="sxs-lookup"><span data-stu-id="2f4b1-280">*Adding an Edit view*</span></span>
...
1. <span data-ttu-id="2f4b1-290">Zamień wszystkie **albumu** fieldset kod następującym kodem:</span><span class="sxs-lookup"><span data-stu-id="2f4b1-290">Replace all the **Album** fieldset code with the following:</span></span>
    ...
    > 2. <span data-ttu-id="2f4b1-294">**SelectList** wartości dla listy rozwijanej.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-294">The **SelectList** of values for the drop-down.</span></span>
...
1. <span data-ttu-id="2f4b1-319">Naciśnij klawisz **F5** do uruchomienia aplikacji.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-319">Press **F5** to run the Application.</span></span>
...
1. <span data-ttu-id="2f4b1-358">Naciśnij klawisz **F5** do uruchomienia aplikacji.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-358">Press **F5** to run the Application.</span></span>
...
1. <span data-ttu-id="2f4b1-388">Jedna metoda akcji spowoduje wyświetlenie formularza potwierdzenia</span><span class="sxs-lookup"><span data-stu-id="2f4b1-388">One action method will display a confirmation form</span></span>
...
1. <span data-ttu-id="2f4b1-392">Otwórz **rozpocząć** rozwiązania, znajdujących się na **źródło/Ex5-HandlingDeletion/Begin/** folderu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-392">Open the **Begin** solution located at **Source/Ex5-HandlingDeletion/Begin/** folder.</span></span> <span data-ttu-id="2f4b1-393">W przeciwnym razie możesz nadal korzystać **zakończenia** uzyskane rozwiązanie, wykonując poprzednim ćwiczeniu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-393">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>
   ...
   1. <span data-ttu-id="2f4b1-394">Po otwarciu dostarczonych **rozpocząć** rozwiązania, musisz pobrać niektórych brakujących pakietów NuGet aby kontynuować.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-394">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="2f4b1-395">Aby to zrobić, kliknij przycisk **projektu** menu i wybierz **Zarządzaj pakietami NuGet**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-395">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
   2. <span data-ttu-id="2f4b1-396">W **Zarządzaj pakietami NuGet** okna dialogowego, kliknij przycisk **przywrócić** celu pobieranie brakujących pakietów.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-396">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
   3. <span data-ttu-id="2f4b1-397">Na koniec Skompiluj rozwiązanie, klikając **kompilacji** | **Kompiluj rozwiązanie**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-397">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

      > [!NOTE]
      > <span data-ttu-id="2f4b1-398">Jedną z zalet przy użyciu narzędzia NuGet jest, że nie masz do wysłania wszystkich bibliotek w projekcie, zmniejszenie jego rozmiar projektu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-398">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="2f4b1-399">Narzędzia Power NuGet określając wersje pakietów w pliku Packages.config, będzie można pobrać wymaganych bibliotek podczas pierwszego uruchomienia projektu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-399">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="2f4b1-400">Jest to, dlaczego konieczne będzie wykonanie tych kroków, po otwarciu istniejącego rozwiązania z tego laboratorium.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-400">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="2f4b1-401">Otwórz **StoreManagerController** klasy.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-401">Open **StoreManagerController** class.</span></span> <span data-ttu-id="2f4b1-402">Aby to zrobić, rozwiń węzeł **kontrolerów** folder i kliknij dwukrotnie **StoreManagerController.cs**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-402">To do this, expand the **Controllers** folder and double-click **StoreManagerController.cs**.</span></span>
3. <span data-ttu-id="2f4b1-403">Akcja usuwania kontrolera jest dokładnie taka sama poprzedniej akcji kontrolera szczegóły magazynu: wysyła zapytanie **albumu** obiektów z bazy danych przy użyciu **identyfikator** podany adres URL i zwraca odpowiednie **widoku**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-403">The Delete controller action is exactly the same as the previous Store Details controller action: it queries the **album** object from the database using the **id** provided in the URL and returns the appropriate **View**.</span></span> <span data-ttu-id="2f4b1-404">Aby to zrobić, Zamień HTTP GET **usunąć** kod metody akcji z następujących czynności:</span><span class="sxs-lookup"><span data-stu-id="2f4b1-404">To do this, replace the HTTP-GET **Delete** action method code with the following:</span></span>

    <span data-ttu-id="2f4b1-405">(Fragment - kodu *ASP.NET MVC 4 pomocników i formularzy i sprawdzanie poprawności — Ex5 obsługi usunięcia HTTP GET akcję usunięcia*)</span><span class="sxs-lookup"><span data-stu-id="2f4b1-405">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex5 Handling Deletion HTTP-GET Delete action*)</span></span>

    [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample15.cs)]
4. <span data-ttu-id="2f4b1-406">Kliknij prawym przyciskiem myszy wewnątrz **usunąć** metody akcji i wybierz **Dodaj widok**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-406">Right-click inside the **Delete** action method and select **Add View**.</span></span> <span data-ttu-id="2f4b1-407">Zostanie wyświetlone okno dialogowe dodawania widoku.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-407">This will bring up the Add View dialog.</span></span>
5. <span data-ttu-id="2f4b1-408">W oknie dialogowym Dodaj widok, sprawdź, czy nazwa widoku jest **usunąć**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-408">In the Add View dialog, verify that the View name is **Delete**.</span></span> <span data-ttu-id="2f4b1-409">Wybierz **utworzyć widok jednoznacznie** opcję i zaznacz **albumu (MvcMusicStore.Models)** z **klasa modelu** listy rozwijanej.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-409">Select the **Create a strongly-typed view** option and select **Album (MvcMusicStore.Models)** from the **Model class** drop-down.</span></span> <span data-ttu-id="2f4b1-410">Wybierz **usunąć** z **szablonu szkieletu** listy rozwijanej.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-410">Select **Delete** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="2f4b1-411">Pozostaw innych pól ich wartości domyślne, a następnie kliknij przycisk **Dodaj**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-411">Leave the other fields with their default value and then click **Add**.</span></span>

    <span data-ttu-id="2f4b1-412">![Dodawanie widoku Delete](aspnet-mvc-4-helpers-forms-and-validation/_static/image15.png "Dodawanie widoku Delete")</span><span class="sxs-lookup"><span data-stu-id="2f4b1-412">![Adding a Delete View](aspnet-mvc-4-helpers-forms-and-validation/_static/image15.png "Adding a Delete View")</span></span>

    <span data-ttu-id="2f4b1-413">*Dodawanie widoku Delete*</span><span class="sxs-lookup"><span data-stu-id="2f4b1-413">*Adding a Delete View*</span></span>
6. <span data-ttu-id="2f4b1-414">Usuń szablon pokazuje wszystkie pola z modelu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-414">The Delete template shows all the fields from the model.</span></span> <span data-ttu-id="2f4b1-415">Zostaną wyświetlone tylko tytuł albumu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-415">You will show only the album's title.</span></span> <span data-ttu-id="2f4b1-416">Aby to zrobić, Zamień zawartość widoku z następującym kodem:</span><span class="sxs-lookup"><span data-stu-id="2f4b1-416">To do this, replace the content of the view with the following code:</span></span>
...
#### <a name="task-2---running-the-application"></a><span data-ttu-id="2f4b1-417">Zadanie 2 — w uruchomionej aplikacji</span><span class="sxs-lookup"><span data-stu-id="2f4b1-417">Task 2 - Running the Application</span></span>

<span data-ttu-id="2f4b1-418">W tym zadaniu zostanie sprawdzić, czy **StoreManager** **usunąć** potwierdzenie usunięcia formularza zostanie wyświetlona strona widoku.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-418">In this task, you will test that the **StoreManager** **Delete** View page displays a confirmation deletion form.</span></span>

1. <span data-ttu-id="2f4b1-419">Naciśnij klawisz **F5** do uruchomienia aplikacji.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-419">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="2f4b1-420">Na stronie głównej datę rozpoczęcia projektu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-420">The project starts in the Home page.</span></span> <span data-ttu-id="2f4b1-421">Zmień adres URL do **/StoreManager**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-421">Change the URL to **/StoreManager**.</span></span> <span data-ttu-id="2f4b1-422">Wybierz albumów można usunąć, klikając **usunąć** i upewnij się, że nowy widok została przekazana.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-422">Select one album to delete by clicking **Delete** and verify that the new view is uploaded.</span></span>

    <span data-ttu-id="2f4b1-423">![Usuwanie albumu](aspnet-mvc-4-helpers-forms-and-validation/_static/image16.png "Usuwanie albumu")</span><span class="sxs-lookup"><span data-stu-id="2f4b1-423">![Deleting an Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image16.png "Deleting an Album")</span></span>

    <span data-ttu-id="2f4b1-424">*Usuwanie albumu*</span><span class="sxs-lookup"><span data-stu-id="2f4b1-424">*Deleting an Album*</span></span>

<a id="Ex05Task3"></a>

<a id="Task_3-_Implementing_the_HTTP-POST_Delete_Action_Method"></a>
#### <a name="task-3--implementing-the-http-post-delete-action-method"></a><span data-ttu-id="2f4b1-425">Zadanie 3 — implementacja metody akcji POST protokołu HTTP Delete</span><span class="sxs-lookup"><span data-stu-id="2f4b1-425">Task 3- Implementing the HTTP-POST Delete Action Method</span></span>

<span data-ttu-id="2f4b1-426">W tym zadaniu wdroży wersji HTTP POST metody akcji usuwania, która będzie wywoływana, gdy użytkownik kliknie **usunąć** przycisku.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-426">In this task, you will implement the HTTP-POST version of the Delete action method that will be invoked when a user clicks the **Delete** button.</span></span> <span data-ttu-id="2f4b1-427">Metoda, należy usunąć albumu w bazie danych.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-427">The method should delete the album in the database.</span></span>

1. <span data-ttu-id="2f4b1-428">Zamknij przeglądarkę, jeśli to konieczne, aby powrócić do okna programu Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-428">Close the browser if needed, to return to the Visual Studio window.</span></span> <span data-ttu-id="2f4b1-429">Otwórz **StoreManagerController** klasy.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-429">Open **StoreManagerController** class.</span></span> <span data-ttu-id="2f4b1-430">Aby to zrobić, rozwiń węzeł **kontrolerów** folder i kliknij dwukrotnie **StoreManagerController.cs**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-430">To do this, expand the **Controllers** folder and double-click **StoreManagerController.cs**.</span></span>
2. <span data-ttu-id="2f4b1-431">Zastąp **usunąć HTTP POST** kod metody akcji z następujących czynności:</span><span class="sxs-lookup"><span data-stu-id="2f4b1-431">Replace **HTTP-POST Delete** action method code with the following:</span></span>

    <span data-ttu-id="2f4b1-432">(Fragment - kodu *ASP.NET MVC 4 pomocników i formularzy i sprawdzanie poprawności — Ex5 obsługi usunięcia HTTP POST akcji*)</span><span class="sxs-lookup"><span data-stu-id="2f4b1-432">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex5 Handling Deletion HTTP-POST Delete action*)</span></span>
...
#### <a name="task-4---running-the-application"></a><span data-ttu-id="2f4b1-433">Zadanie 4 — uruchamianie aplikacji</span><span class="sxs-lookup"><span data-stu-id="2f4b1-433">Task 4 - Running the Application</span></span>

<span data-ttu-id="2f4b1-434">W tym zadaniu zostanie sprawdzić, czy **StoreManager Delete** strony widoku umożliwia usuwanie albumu, a następnie przekierowuje do widoku indeksu StoreManager.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-434">In this task, you will test that the **StoreManager Delete** View page lets you delete an Album and then redirects to the StoreManager Index View.</span></span>

1. <span data-ttu-id="2f4b1-435">Naciśnij klawisz **F5** do uruchomienia aplikacji.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-435">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="2f4b1-436">Na stronie głównej datę rozpoczęcia projektu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-436">The project starts in the Home page.</span></span> <span data-ttu-id="2f4b1-437">Zmień adres URL do **/StoreManager**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-437">Change the URL to **/StoreManager**.</span></span> <span data-ttu-id="2f4b1-438">Wybierz albumów można usunąć, klikając **usunąć.**</span><span class="sxs-lookup"><span data-stu-id="2f4b1-438">Select one album to delete by clicking **Delete.**</span></span> <span data-ttu-id="2f4b1-439">Potwierdź decyzję, klikając **usunąć** przycisk:</span><span class="sxs-lookup"><span data-stu-id="2f4b1-439">Confirm the deletion by clicking **Delete** button:</span></span>

    <span data-ttu-id="2f4b1-440">![Usuwanie albumu](aspnet-mvc-4-helpers-forms-and-validation/_static/image17.png "Usuwanie albumu")</span><span class="sxs-lookup"><span data-stu-id="2f4b1-440">![Deleting an Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image17.png "Deleting an Album")</span></span>

    <span data-ttu-id="2f4b1-441">*Usuwanie albumu*</span><span class="sxs-lookup"><span data-stu-id="2f4b1-441">*Deleting an Album*</span></span>
3. <span data-ttu-id="2f4b1-442">Sprawdź, czy album została usunięta, ponieważ nie ma w **indeksu** strony.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-442">Verify that the album was deleted since it does not appear in the **Index** page.</span></span>

<a id="Exercise6"></a>

<a id="Exercise_6_Adding_Validation"></a>
### <a name="exercise-6-adding-validation"></a><span data-ttu-id="2f4b1-443">Ćwiczenie 6: Dodawanie walidacji</span><span class="sxs-lookup"><span data-stu-id="2f4b1-443">Exercise 6: Adding Validation</span></span>

<span data-ttu-id="2f4b1-444">Obecnie tworzenie i edytowanie formularzy, które zostały spełnione, nie należy wykonywać dowolny rodzaj sprawdzania poprawności.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-444">Currently, the Create and Edit forms you have in place do not perform any kind of validation.</span></span> <span data-ttu-id="2f4b1-445">Jeśli użytkownik opuści wymaganego pola puste lub typ litery w polu Cena, zostanie wyświetlony błąd będzie się z bazy danych.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-445">If the user leaves a required field blank or type letters in the price field, the first error you will get will be from the database.</span></span>

<span data-ttu-id="2f4b1-446">Sprawdzanie poprawności można dodać do aplikacji przez dodanie do własnej klasy modelu adnotacji danych.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-446">You can add validation to the application by adding Data Annotations to your model class.</span></span> <span data-ttu-id="2f4b1-447">Adnotacje danych umożliwiają zawierająca opis reguły, które chcesz zastosować do właściwości modelu i ASP.NET MVC zajmie się wymuszanie i komunikatem odpowiednie dla użytkowników.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-447">Data Annotations allow describing the rules you want applied to your model properties, and ASP.NET MVC will take care of enforcing and displaying appropriate message to users.</span></span>

<a id="Ex06Task1"></a>

<a id="Task_1_-_Adding_Data_Annotations"></a>
#### <a name="task-1---adding-data-annotations"></a><span data-ttu-id="2f4b1-448">Zadanie 1 — Dodawanie adnotacji danych</span><span class="sxs-lookup"><span data-stu-id="2f4b1-448">Task 1 - Adding Data Annotations</span></span>

<span data-ttu-id="2f4b1-449">To zadanie spowoduje dodanie adnotacji danych do modelu albumy, aby ułatwić tworzenie i edytowanie strony ekranu komunikatów dotyczących sprawdzania poprawności, gdy jest to konieczne.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-449">In this task, you will add Data Annotations to the Album Model that will make the Create and Edit page display validation messages when appropriate.</span></span>

<span data-ttu-id="2f4b1-450">Proste klasy modelu, dodawanie adnotacji danych tylko odbywa się przez dodanie **przy użyciu** instrukcji dla **System.ComponentModel.DataAnnotation**, następnie umieszczenie **[wymagane]** atrybutu na odpowiednie właściwości.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-450">For a simple Model class, adding a Data Annotation is just handled by adding a **using** statement for **System.ComponentModel.DataAnnotation**, then placing a **[Required]** attribute on the appropriate properties.</span></span> <span data-ttu-id="2f4b1-451">Poniższy przykład spowodowałoby **nazwa** właściwości wymaganego pola w widoku.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-451">The following example would make the **Name** property a required field in the View.</span></span>

[!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample18.cs)]

<span data-ttu-id="2f4b1-452">To nieco bardziej złożone w przypadkach, takich jak ta aplikacja gdzie jest generowany modelu danych jednostki.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-452">This is a little more complex in cases like this application where the Entity Data Model is generated.</span></span> <span data-ttu-id="2f4b1-453">Jeśli dodano adnotacji danych bezpośrednio do klasy modeli, będą one zastąpione po zaktualizowaniu modelu z bazy danych.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-453">If you added Data Annotations directly to the model classes, they would be overwritten if you update the model from the database.</span></span> <span data-ttu-id="2f4b1-454">Zamiast tego możesz wprowadzić korzystanie z klasy częściowe metadanych, które będą istnieć do przechowywania adnotacje i są skojarzone z tym modelem klasy przy użyciu **[MetadataType]** atrybutu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-454">Instead, you can make use of metadata partial classes which will exist to hold the annotations and are associated with the model classes using the **[MetadataType]** attribute.</span></span>

1. <span data-ttu-id="2f4b1-455">Otwórz **rozpocząć** rozwiązania, znajdujących się na **źródło/Ex6-AddingValidation/Begin/** folderu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-455">Open the **Begin** solution located at **Source/Ex6-AddingValidation/Begin/** folder.</span></span> <span data-ttu-id="2f4b1-456">W przeciwnym razie możesz nadal korzystać **zakończenia** uzyskane rozwiązanie, wykonując poprzednim ćwiczeniu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-456">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>

   1. <span data-ttu-id="2f4b1-457">Po otwarciu dostarczonych **rozpocząć** rozwiązania, musisz pobrać niektórych brakujących pakietów NuGet aby kontynuować.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-457">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="2f4b1-458">Aby to zrobić, kliknij przycisk **projektu** menu i wybierz **Zarządzaj pakietami NuGet**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-458">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
   2. <span data-ttu-id="2f4b1-459">W **Zarządzaj pakietami NuGet** okna dialogowego, kliknij przycisk **przywrócić** celu pobieranie brakujących pakietów.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-459">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
   3. <span data-ttu-id="2f4b1-460">Na koniec Skompiluj rozwiązanie, klikając **kompilacji** | **Kompiluj rozwiązanie**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-460">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

      > [!NOTE]
      > <span data-ttu-id="2f4b1-461">Jedną z zalet przy użyciu narzędzia NuGet jest, że nie masz do wysłania wszystkich bibliotek w projekcie, zmniejszenie jego rozmiar projektu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-461">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="2f4b1-462">Narzędzia Power NuGet określając wersje pakietów w pliku Packages.config, będzie można pobrać wymaganych bibliotek podczas pierwszego uruchomienia projektu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-462">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="2f4b1-463">Jest to, dlaczego konieczne będzie wykonanie tych kroków, po otwarciu istniejącego rozwiązania z tego laboratorium.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-463">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="2f4b1-464">Otwórz **Album.cs** z **modele** folderu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-464">Open the **Album.cs** from the **Models** folder.</span></span>
3. <span data-ttu-id="2f4b1-465">Zastąp **Album.cs** zawartości ze wyróżniony kod, aby wyglądały one podobnie do następującej:</span><span class="sxs-lookup"><span data-stu-id="2f4b1-465">Replace **Album.cs** content with the highlighted code, so that it looks like the following:</span></span>

    > [!NOTE]
    > <span data-ttu-id="2f4b1-466">Wiersz **[DisplayFormat(ConvertEmptyStringToNull=false)]** wskazuje, czy puste ciągi z modelu nie będą konwertowane do wartości null po zaktualizowaniu pole danych w źródle danych.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-466">The line **[DisplayFormat(ConvertEmptyStringToNull=false)]** indicates that empty strings from the model won't be converted to null when the data field is updated in the data source.</span></span> <span data-ttu-id="2f4b1-467">To ustawienie można będzie zapobiec Wystąpił wyjątek podczas programu Entity Framework przed adnotacji danych sprawdza poprawność pól przypisuje wartości null do modelu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-467">This setting will avoid an exception when the Entity Framework assigns null values to the model before Data Annotation validates the fields.</span></span>

    <span data-ttu-id="2f4b1-468">(Fragment - kodu *ASP.NET MVC 4 pomocników i formularzy i sprawdzanie poprawności — częściowej klasy metadanych albumu Ex6*)</span><span class="sxs-lookup"><span data-stu-id="2f4b1-468">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex6 Album metadata partial class*)</span></span>

    [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample19.cs)]

    > [!NOTE]
    > <span data-ttu-id="2f4b1-469">To **albumu** ma częściowej klasy **MetadataType** atrybut, który wskazuje **AlbumMetaData** klasy dla adnotacji danych.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-469">This **Album** partial class has a **MetadataType** attribute which points to the **AlbumMetaData** class for the Data Annotations.</span></span> <span data-ttu-id="2f4b1-470">Oto niektóre atrybuty adnotacji danych używanego dla adnotacji modelu albumu:</span><span class="sxs-lookup"><span data-stu-id="2f4b1-470">These are some of the Data Annotation attributes you are using to annotate the Album model:</span></span>
    > 
    > - <span data-ttu-id="2f4b1-471">Niewymagana — wskazuje, że właściwość jest polem obowiązkowym</span><span class="sxs-lookup"><span data-stu-id="2f4b1-471">Required - Indicates that the property is a required field</span></span>
    > - <span data-ttu-id="2f4b1-472">Nazwa wyświetlana — Określa tekst, który ma być używany z pola formularza i komunikatów dotyczących sprawdzania poprawności</span><span class="sxs-lookup"><span data-stu-id="2f4b1-472">DisplayName - Defines the text to be used on form fields and validation messages</span></span>
    > - <span data-ttu-id="2f4b1-473">DisplayFormat — określa sposób wyświetlania i sformatowane pola danych.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-473">DisplayFormat - Specifies how data fields are displayed and formatted.</span></span>
    > - <span data-ttu-id="2f4b1-474">StringLength — określa maksymalną długość pola ciągu</span><span class="sxs-lookup"><span data-stu-id="2f4b1-474">StringLength - Defines a maximum length for a string field</span></span>
    > - <span data-ttu-id="2f4b1-475">Zakres — zapewnia maksymalne i minimalne wartości pola numerycznego</span><span class="sxs-lookup"><span data-stu-id="2f4b1-475">Range - Gives a maximum and minimum value for a numeric field</span></span>
    > - <span data-ttu-id="2f4b1-476">ScaffoldColumn — umożliwia ukrywanie pól z edytora formularzy</span><span class="sxs-lookup"><span data-stu-id="2f4b1-476">ScaffoldColumn - Allows hiding fields from editor forms</span></span>

<a id="Ex06Task2"></a>

<a id="Task_2_-_Running_the_Application"></a>
#### <a name="task-2---running-the-application"></a><span data-ttu-id="2f4b1-477">Zadanie 2 — w uruchomionej aplikacji</span><span class="sxs-lookup"><span data-stu-id="2f4b1-477">Task 2 - Running the Application</span></span>

<span data-ttu-id="2f4b1-478">To zadanie będzie testowane czy tworzenie i edytowanie strony weryfikacji pól, przy użyciu nazw wyświetlanych w ostatnim zadaniem.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-478">In this task, you will test that the Create and Edit pages validate fields, using the display names chosen in the last task.</span></span>

1. <span data-ttu-id="2f4b1-479">Naciśnij klawisz **F5** do uruchomienia aplikacji.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-479">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="2f4b1-480">Na stronie głównej datę rozpoczęcia projektu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-480">The project starts in the Home page.</span></span> <span data-ttu-id="2f4b1-481">Zmień adres URL do **/StoreManager/utworzyć**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-481">Change the URL to **/StoreManager/Create**.</span></span> <span data-ttu-id="2f4b1-482">Sprawdź, czy nazwy wyświetlane są zgodne z typami klasy częściowej (takich jak **albumów graficznych URL** zamiast **AlbumArtUrl**)</span><span class="sxs-lookup"><span data-stu-id="2f4b1-482">Verify that the display names match the ones in the partial class (like **Album Art URL** instead of **AlbumArtUrl**)</span></span>
3. <span data-ttu-id="2f4b1-483">Kliknij przycisk **Utwórz**, bez wypełniania formularza.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-483">Click **Create**, without filling the form.</span></span> <span data-ttu-id="2f4b1-484">Sprawdź, czy możesz uzyskać odpowiednie komunikatów dotyczących sprawdzania poprawności.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-484">Verify that you get the corresponding validation messages.</span></span>

    <span data-ttu-id="2f4b1-485">![Zweryfikowany pola na stronie Utwórz](aspnet-mvc-4-helpers-forms-and-validation/_static/image18.png "zweryfikowane pola na stronie Utwórz")</span><span class="sxs-lookup"><span data-stu-id="2f4b1-485">![Validated fields in the Create page](aspnet-mvc-4-helpers-forms-and-validation/_static/image18.png "Validated fields in the Create page")</span></span>

    <span data-ttu-id="2f4b1-486">*Sprawdzone pola na stronie Utwórz*</span><span class="sxs-lookup"><span data-stu-id="2f4b1-486">*Validated fields in the Create page*</span></span>
4. <span data-ttu-id="2f4b1-487">Możesz sprawdzić, czy występuje takie same z **Edytuj** strony.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-487">You can verify that the same occurs with the **Edit** page.</span></span> <span data-ttu-id="2f4b1-488">Zmień adres URL do **/StoreManager/Edit/1** i upewnij się, że nazwy wyświetlane są zgodne z typami klasy częściowej (takich jak **albumów graficznych URL** zamiast **AlbumArtUrl**).</span><span class="sxs-lookup"><span data-stu-id="2f4b1-488">Change the URL to **/StoreManager/Edit/1** and verify that the display names match the ones in the partial class (like **Album Art URL** instead of **AlbumArtUrl**).</span></span> <span data-ttu-id="2f4b1-489">Pusty **tytuł** i **cen** pola i kliknij przycisk **zapisać**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-489">Empty the **Title** and **Price** fields and click **Save**.</span></span> <span data-ttu-id="2f4b1-490">Sprawdź, czy możesz uzyskać odpowiednie komunikatów dotyczących sprawdzania poprawności.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-490">Verify that you get the corresponding validation messages.</span></span>

    ![Sprawdzone pola na stronie edycji](aspnet-mvc-4-helpers-forms-and-validation/_static/image19.png)

    <span data-ttu-id="2f4b1-492">*Sprawdzone pola na stronie edycji*</span><span class="sxs-lookup"><span data-stu-id="2f4b1-492">*Validated fields in the Edit page*</span></span>

<a id="Exercise7"></a>

<a id="Exercise_7_Using_Unobtrusive_jQuery_at_Client_Side"></a>
### <a name="exercise-7-using-unobtrusive-jquery-at-client-side"></a><span data-ttu-id="2f4b1-493">Ćwiczenie 7: Przy użyciu jQuery dyskretny kod po stronie klienta</span><span class="sxs-lookup"><span data-stu-id="2f4b1-493">Exercise 7: Using Unobtrusive jQuery at Client Side</span></span>

<span data-ttu-id="2f4b1-494">W tym ćwiczeniu dowiesz się, jak włączyć dotyczącą weryfikacji jQuery MVC 4 dyskretny kod po stronie klienta.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-494">In this exercise, you will learn how to enable MVC 4 Unobtrusive jQuery validation at client side.</span></span>

> [!NOTE]
> <span data-ttu-id="2f4b1-495">Dyskretnego kodu jQuery używa prefiksu danych ajax JavaScript do wywołania metody akcji na serwer, a nie emisji intrusively wbudowane skrypty klienta.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-495">The Unobtrusive jQuery uses data-ajax prefix JavaScript to invoke action methods on the server rather than intrusively emitting inline client scripts.</span></span>


<a id="Ex7Task1"></a>

<a id="Task_1_-_Running_the_Application_before_Enabling_Unobtrusive_jQuery"></a>
#### <a name="task-1---running-the-application-before-enabling-unobtrusive-jquery"></a><span data-ttu-id="2f4b1-496">Zadanie 1 - uruchamiania aplikacji przed włączeniem dyskretnego kodu jQuery</span><span class="sxs-lookup"><span data-stu-id="2f4b1-496">Task 1 - Running the Application before Enabling Unobtrusive jQuery</span></span>

<span data-ttu-id="2f4b1-497">W ramach tego zadania należy uruchomić aplikację przed tym jQuery, aby porównać oba modele sprawdzania poprawności.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-497">In this task, you will run the application before including jQuery in order to compare both validation models.</span></span>

1. <span data-ttu-id="2f4b1-498">Otwórz **rozpocząć** rozwiązania, znajdujących się na **źródło/Ex7-UnobtrusivejQueryValidation/Begin/** folderu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-498">Open the **Begin** solution located at **Source/Ex7-UnobtrusivejQueryValidation/Begin/** folder.</span></span> <span data-ttu-id="2f4b1-499">W przeciwnym razie możesz nadal korzystać **zakończenia** uzyskane rozwiązanie, wykonując poprzednim ćwiczeniu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-499">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>

   1. <span data-ttu-id="2f4b1-500">Po otwarciu dostarczonych **rozpocząć** rozwiązania, musisz pobrać niektórych brakujących pakietów NuGet aby kontynuować.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-500">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="2f4b1-501">Aby to zrobić, kliknij przycisk **projektu** menu i wybierz **Zarządzaj pakietami NuGet**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-501">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
   2. <span data-ttu-id="2f4b1-502">W **Zarządzaj pakietami NuGet** okna dialogowego, kliknij przycisk **przywrócić** celu pobieranie brakujących pakietów.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-502">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
   3. <span data-ttu-id="2f4b1-503">Na koniec Skompiluj rozwiązanie, klikając **kompilacji** | **Kompiluj rozwiązanie**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-503">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

      > [!NOTE]
      > <span data-ttu-id="2f4b1-504">Jedną z zalet przy użyciu narzędzia NuGet jest, że nie masz do wysłania wszystkich bibliotek w projekcie, zmniejszenie jego rozmiar projektu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-504">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="2f4b1-505">Narzędzia Power NuGet określając wersje pakietów w pliku Packages.config, będzie można pobrać wymaganych bibliotek podczas pierwszego uruchomienia projektu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-505">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="2f4b1-506">Jest to, dlaczego konieczne będzie wykonanie tych kroków, po otwarciu istniejącego rozwiązania z tego laboratorium.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-506">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="2f4b1-507">Naciśnij klawisz **F5** do uruchomienia aplikacji.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-507">Press **F5** to run the application.</span></span>
3. <span data-ttu-id="2f4b1-508">Na stronie głównej datę rozpoczęcia projektu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-508">The project starts in the Home page.</span></span> <span data-ttu-id="2f4b1-509">Przeglądaj **/StoreManager/Utwórz** i kliknij przycisk **Utwórz** bez wypełniania formularza, aby sprawdzić, czy możesz uzyskać komunikatów dotyczących sprawdzania poprawności:</span><span class="sxs-lookup"><span data-stu-id="2f4b1-509">Browse **/StoreManager/Create** and click **Create** without filling the form to verify that you get validation messages:</span></span>

    <span data-ttu-id="2f4b1-510">![Sprawdzanie poprawności klienta wyłączone](aspnet-mvc-4-helpers-forms-and-validation/_static/image20.png "weryfikacji klienta wyłączone")</span><span class="sxs-lookup"><span data-stu-id="2f4b1-510">![Client validation disabled](aspnet-mvc-4-helpers-forms-and-validation/_static/image20.png "Client validation disabled")</span></span>

    <span data-ttu-id="2f4b1-511">*Sprawdzanie poprawności klienta wyłączone*</span><span class="sxs-lookup"><span data-stu-id="2f4b1-511">*Client validation disabled*</span></span>
4. <span data-ttu-id="2f4b1-512">W przeglądarce otwórz kod źródłowy HTML:</span><span class="sxs-lookup"><span data-stu-id="2f4b1-512">In the browser, open the HTML source code:</span></span>
...
#### <a name="task-2---enabling-unobtrusive-client-validation"></a><span data-ttu-id="2f4b1-513">Zadanie 2 — Włączanie sprawdzania poprawności dyskretnego kodu klienta</span><span class="sxs-lookup"><span data-stu-id="2f4b1-513">Task 2 - Enabling Unobtrusive Client Validation</span></span>

<span data-ttu-id="2f4b1-514">To zadanie spowoduje włączenie jQuery **sprawdzania poprawności dyskretnego kodu klienta** z **Web.config** pliku, który jest domyślnie ustawiony na wartość false w wszystkie nowe projekty programu ASP.NET MVC 4.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-514">In this task, you will enable jQuery **unobtrusive client validation** from **Web.config** file, which is by default set to false in all new ASP.NET MVC 4 projects.</span></span> <span data-ttu-id="2f4b1-515">Ponadto należy dodać się, że niezbędne skrypty odwołania, aby jQuery pracy dyskretny kod weryfikacji klienta.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-515">Additionally, you will add the necessary scripts references to make jQuery Unobtrusive Client Validation work.</span></span>

1. <span data-ttu-id="2f4b1-516">Otwórz **Web.Config** plików w katalogu głównym projektu i upewnij się, że **ClientValidationEnabled** i **UnobtrusiveJavaScriptEnabled** klucze wartości są ustawiane na **true**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-516">Open **Web.Config** file at project root, and make sure that the **ClientValidationEnabled** and **UnobtrusiveJavaScriptEnabled** keys values are set to **true**.</span></span>

    [!code-xml[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample21.xml)]

    > [!NOTE]
    > <span data-ttu-id="2f4b1-517">Można także włączyć sprawdzanie poprawności klienta przez kod w Global.asax.cs, aby uzyskać takie same wyniki:</span><span class="sxs-lookup"><span data-stu-id="2f4b1-517">You can also enable client validation by code at Global.asax.cs to get the same results:</span></span>
    > 
    > <span data-ttu-id="2f4b1-518">**HtmlHelper.ClientValidationEnabled = true;**</span><span class="sxs-lookup"><span data-stu-id="2f4b1-518">**HtmlHelper.ClientValidationEnabled = true;**</span></span>
    > 
    > <span data-ttu-id="2f4b1-519">Ponadto można przypisać atrybutu ClientValidationEnabled w żadnym kontrolerze mają zachowania niestandardowego.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-519">Additionally, you can assign ClientValidationEnabled attribute into any controller to have a custom behavior.</span></span>
2. <span data-ttu-id="2f4b1-520">Otwórz **Create.cshtml** w **Views\StoreManager**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-520">Open **Create.cshtml** at **Views\StoreManager**.</span></span>
3. <span data-ttu-id="2f4b1-521">Upewnij się, że następujące pliki skryptu **jquery.validate** i **jquery.validate.unobtrusive**, odwołuje się widok poprzez &quot; **~/bundles/jqueryval** &quot; pakietu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-521">Make sure the following script files, **jquery.validate** and **jquery.validate.unobtrusive**, are referenced in the view throught the &quot;**~/bundles/jqueryval**&quot; bundle.</span></span>

    [!code-cshtml[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample22.cshtml)]

    > [!NOTE]
    > <span data-ttu-id="2f4b1-522">Te biblioteki jQuery zostaną uwzględnione w nowych projektów MVC 4.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-522">All these jQuery libraries are included in MVC 4 new projects.</span></span> <span data-ttu-id="2f4b1-523">Można znaleźć więcej bibliotek w **/skrypty** folderu projektu należy.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-523">You can find more libraries in the **/Scripts** folder of you project.</span></span>
    > 
    > <span data-ttu-id="2f4b1-524">Aby tej weryfikacji pracy biblioteki, musisz dodać odwołanie do biblioteki framework jQuery.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-524">In order to make this validation libraries work, you need to add a reference to the jQuery framework library.</span></span> <span data-ttu-id="2f4b1-525">Ponieważ to odwołanie zostało już dodane na  **\_Layout.cshtml** plików, nie trzeba go dodać w tego widoku.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-525">Since this reference is already added in the **\_Layout.cshtml** file, you do not need to add it in this particular view.</span></span>

<a id="Ex7Task3"></a>

<a id="Task_3_-_Running_the_Application_Using_Unobtrusive_jQuery_Validation"></a>
#### <a name="task-3---running-the-application-using-unobtrusive-jquery-validation"></a><span data-ttu-id="2f4b1-526">Zadanie 3 — uruchomiona dyskretnego kodu przy użyciu aplikacji jQuery sprawdzania poprawności</span><span class="sxs-lookup"><span data-stu-id="2f4b1-526">Task 3 - Running the Application Using Unobtrusive jQuery Validation</span></span>

<span data-ttu-id="2f4b1-527">W tym zadaniu zostanie sprawdzić, czy **StoreManager** utworzyć widok szablonu przeprowadza weryfikacji po stronie klienta przy użyciu biblioteki jQuery podczas tworzenia nowego albumu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-527">In this task, you will test that the **StoreManager** create view template performs client side validation using jQuery libraries when the user creates a new album.</span></span>

1. <span data-ttu-id="2f4b1-528">Naciśnij klawisz **F5** do uruchomienia aplikacji.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-528">Press **F5** to run the application.</span></span>
2. <span data-ttu-id="2f4b1-529">Na stronie głównej datę rozpoczęcia projektu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-529">The project starts in the Home page.</span></span> <span data-ttu-id="2f4b1-530">Przeglądaj **/StoreManager/Utwórz** i kliknij przycisk **Utwórz** bez wypełniania formularza, aby sprawdzić, czy możesz uzyskać komunikatów dotyczących sprawdzania poprawności:</span><span class="sxs-lookup"><span data-stu-id="2f4b1-530">Browse **/StoreManager/Create** and click **Create** without filling the form to verify that you get validation messages:</span></span>

    <span data-ttu-id="2f4b1-531">![Sprawdzanie poprawności klienta z jQuery włączone](aspnet-mvc-4-helpers-forms-and-validation/_static/image21.png "weryfikacji klienta z jQuery włączone")</span><span class="sxs-lookup"><span data-stu-id="2f4b1-531">![Client validation with jQuery enabled](aspnet-mvc-4-helpers-forms-and-validation/_static/image21.png "Client validation with jQuery enabled")</span></span>

    <span data-ttu-id="2f4b1-532">*Sprawdzanie poprawności klienta z jQuery włączone*</span><span class="sxs-lookup"><span data-stu-id="2f4b1-532">*Client validation with jQuery enabled*</span></span>
3. <span data-ttu-id="2f4b1-533">W przeglądarce otwórz kod źródłowy Utwórz widok:</span><span class="sxs-lookup"><span data-stu-id="2f4b1-533">In the browser, open the source code for Create view:</span></span>

    [!code-html[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample23.html)]

   > [!NOTE]
   > <span data-ttu-id="2f4b1-534">Dla każdej reguły weryfikacji klienta jQuery dyskretny kod dodaje atrybut z danymi-val -*rulename*=&quot;*komunikat*&quot;.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-534">For each client validation rule, Unobtrusive jQuery adds an attribute with data-val-*rulename*=&quot;*message*&quot;.</span></span> <span data-ttu-id="2f4b1-535">Poniżej znajduje się lista znaczników tej Unobtrusive jQuery wstawia do pola wejściowego html do sprawdzania poprawności klienta:</span><span class="sxs-lookup"><span data-stu-id="2f4b1-535">Below is a list of tags that Unobtrusive jQuery inserts into the html input field to perform client validation:</span></span>
   > 
   > - <span data-ttu-id="2f4b1-536">Val danych</span><span class="sxs-lookup"><span data-stu-id="2f4b1-536">Data-val</span></span>
   > - <span data-ttu-id="2f4b1-537">Dane val numerów</span><span class="sxs-lookup"><span data-stu-id="2f4b1-537">Data-val-number</span></span>
   > - <span data-ttu-id="2f4b1-538">Zakres danych val</span><span class="sxs-lookup"><span data-stu-id="2f4b1-538">Data-val-range</span></span>
   > - <span data-ttu-id="2f4b1-539">Dane val zakresu min / danych val zakresu max.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-539">Data-val-range-min / Data-val-range-max</span></span>
   > - <span data-ttu-id="2f4b1-540">Wymagane wartości danych</span><span class="sxs-lookup"><span data-stu-id="2f4b1-540">Data-val-required</span></span>
   > - <span data-ttu-id="2f4b1-541">Długość danych val</span><span class="sxs-lookup"><span data-stu-id="2f4b1-541">Data-val-length</span></span>
   > - <span data-ttu-id="2f4b1-542">Dane val długość max / danych val długość min</span><span class="sxs-lookup"><span data-stu-id="2f4b1-542">Data-val-length-max / Data-val-length-min</span></span>
   > 
   > <span data-ttu-id="2f4b1-543">Wszystkie wartości są wypełniane modelu **adnotacji danych elementu**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-543">All the data values are filled with model **Data Annotation**.</span></span> <span data-ttu-id="2f4b1-544">Następnie całą logikę, która działa po stronie serwera może działać po stronie klienta.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-544">Then, all the logic that works at server side can be run at client side.</span></span> <span data-ttu-id="2f4b1-545">Na przykład atrybut cen ma następujące adnotacji danych w modelu:</span><span class="sxs-lookup"><span data-stu-id="2f4b1-545">For example, Price attribute has the following data annotation in the model:</span></span>
   > 
   > [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample24.cs)]
   > 
   > <span data-ttu-id="2f4b1-546">Po zakończeniu korzystania z dyskretnego kodu jQuery jest wygenerowanego kodu:</span><span class="sxs-lookup"><span data-stu-id="2f4b1-546">After using Unobtrusive jQuery, the generated code is:</span></span>
   > 
...
<a id="Summary"></a>
## <a name="summary"></a><span data-ttu-id="2f4b1-547">Podsumowanie</span><span class="sxs-lookup"><span data-stu-id="2f4b1-547">Summary</span></span>

<span data-ttu-id="2f4b1-548">Wykonując tego laboratorium Hands-On zapoznaniu umożliwienie użytkownikom na zmianę danych przechowywanych w bazie danych przy użyciu następujących czynności:</span><span class="sxs-lookup"><span data-stu-id="2f4b1-548">By completing this Hands-On Lab you have learned how to enable users to change the data stored in the database with the use of the following:</span></span>

- <span data-ttu-id="2f4b1-549">Indeks, tworzenia, edytowania, usuwania, takich jak akcji kontrolera</span><span class="sxs-lookup"><span data-stu-id="2f4b1-549">Controller actions like Index, Create, Edit, Delete</span></span>
- <span data-ttu-id="2f4b1-550">Funkcja szkieletów ASP.NET MVC do wyświetlania właściwości tabeli HTML</span><span class="sxs-lookup"><span data-stu-id="2f4b1-550">ASP.NET MVC's scaffolding feature for displaying properties in an HTML table</span></span>
- <span data-ttu-id="2f4b1-551">Środowisko niestandardowych pomocników HTML zwiększające użytkownika</span><span class="sxs-lookup"><span data-stu-id="2f4b1-551">Custom HTML helpers to improve user experience</span></span>
- <span data-ttu-id="2f4b1-552">Metody akcji, które reagują na HTTP GET lub POST protokołu HTTP wywołania</span><span class="sxs-lookup"><span data-stu-id="2f4b1-552">Action methods that react to either HTTP-GET or HTTP-POST calls</span></span>
- <span data-ttu-id="2f4b1-553">Szablon udostępniony edytora dla podobnych szablonów widoków, takich jak tworzenie i edytowanie</span><span class="sxs-lookup"><span data-stu-id="2f4b1-553">A shared editor template for similar View templates like Create and Edit</span></span>
- <span data-ttu-id="2f4b1-554">Formularz elementów, takich jak listy rozwijane</span><span class="sxs-lookup"><span data-stu-id="2f4b1-554">Form elements like drop-downs</span></span>
- <span data-ttu-id="2f4b1-555">Adnotacje danych na potrzeby sprawdzania poprawności modelu</span><span class="sxs-lookup"><span data-stu-id="2f4b1-555">Data annotations for Model validation</span></span>
- <span data-ttu-id="2f4b1-556">Weryfikacja po stronie klienta za pomocą biblioteki dyskretnego kodu jQuery</span><span class="sxs-lookup"><span data-stu-id="2f4b1-556">Client Side Validation using jQuery Unobtrusive library</span></span>

<a id="AppendixA"></a>

<a id="Appendix_A_Installing_Visual_Studio_Express_2012_for_Web"></a>
## <a name="appendix-a-installing-visual-studio-express-2012-for-web"></a><span data-ttu-id="2f4b1-557">Dodatek A: Instalowanie programu Visual Studio Express 2012 for Web</span><span class="sxs-lookup"><span data-stu-id="2f4b1-557">Appendix A: Installing Visual Studio Express 2012 for Web</span></span>

<span data-ttu-id="2f4b1-558">Można zainstalować **Microsoft Visual Studio Express 2012 for Web** lub innym &quot;Express&quot; przy użyciu wersji **[Instalatora platformy sieci Web firmy Microsoft](https://www.microsoft.com/web/downloads/platform.aspx)**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-558">You can install **Microsoft Visual Studio Express 2012 for Web** or another &quot;Express&quot; version using the **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)**.</span></span> <span data-ttu-id="2f4b1-559">Poniższe instrukcje przedstawiono czynności wymagane do zainstalowania *programu Visual studio Express 2012 for Web* przy użyciu *Instalatora platformy sieci Web firmy Microsoft*.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-559">The following instructions guide you through the steps required to install *Visual studio Express 2012 for Web* using *Microsoft Web Platform Installer*.</span></span>

1. <span data-ttu-id="2f4b1-560">Przejdź do [ [ https://go.microsoft.com/?linkid=9810169 ](https://go.microsoft.com/?linkid=9810169) ](https://go.microsoft.com/?linkid=9810169).</span><span class="sxs-lookup"><span data-stu-id="2f4b1-560">Go to [[https://go.microsoft.com/?linkid=9810169](https://go.microsoft.com/?linkid=9810169)](https://go.microsoft.com/?linkid=9810169).</span></span> <span data-ttu-id="2f4b1-561">Alternatywnie, jeśli została już zainstalowana Instalatora platformy sieci Web, można otworzyć go i Wyszukaj produkt &quot; <em>programu Visual Studio Express 2012 for Web z zestawem Windows Azure SDK</em>&quot;.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-561">Alternatively, if you already have installed Web Platform Installer, you can open it and search for the product &quot;<em>Visual Studio Express 2012 for Web with Windows Azure SDK</em>&quot;.</span></span>
2. <span data-ttu-id="2f4b1-562">Polecenie **teraz zainstalować**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-562">Click on **Install Now**.</span></span> <span data-ttu-id="2f4b1-563">Jeśli nie masz **Instalatora platformy sieci Web** nastąpi przekierowanie do pobrania i zainstalowania go najpierw.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-563">If you do not have **Web Platform Installer** you will be redirected to download and install it first.</span></span>
3. <span data-ttu-id="2f4b1-564">Raz **Instalatora platformy sieci Web** jest otwarty, kliknij przycisk **zainstalować** można uruchomić Instalatora.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-564">Once **Web Platform Installer** is open, click **Install** to start the setup.</span></span>

    <span data-ttu-id="2f4b1-565">![Instalowanie programu Visual Studio Express](aspnet-mvc-4-helpers-forms-and-validation/_static/image22.png "instalacji programu Visual Studio Express")</span><span class="sxs-lookup"><span data-stu-id="2f4b1-565">![Install Visual Studio Express](aspnet-mvc-4-helpers-forms-and-validation/_static/image22.png "Install Visual Studio Express")</span></span>

    <span data-ttu-id="2f4b1-566">*Instalowanie programu Visual Studio Express*</span><span class="sxs-lookup"><span data-stu-id="2f4b1-566">*Install Visual Studio Express*</span></span>
4. <span data-ttu-id="2f4b1-567">Odczytywanie wszystkich produktów licencji i warunków, a następnie kliknij przycisk **akceptuję** aby kontynuować.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-567">Read all the products' licenses and terms and click **I Accept** to continue.</span></span>

    ![Akceptowanie umowy licencyjnej](aspnet-mvc-4-helpers-forms-and-validation/_static/image23.png)

    <span data-ttu-id="2f4b1-569">*Akceptowanie umowy licencyjnej*</span><span class="sxs-lookup"><span data-stu-id="2f4b1-569">*Accepting the license terms*</span></span>
5. <span data-ttu-id="2f4b1-570">Poczekaj na zakończenie procesu pobierania i instalacji.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-570">Wait until the downloading and installation process completes.</span></span>

    ![Postęp instalacji](aspnet-mvc-4-helpers-forms-and-validation/_static/image24.png)

    <span data-ttu-id="2f4b1-572">*Postęp instalacji*</span><span class="sxs-lookup"><span data-stu-id="2f4b1-572">*Installation progress*</span></span>
6. <span data-ttu-id="2f4b1-573">Po zakończeniu instalacji kliknij przycisk **Zakończ**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-573">When the installation completes, click **Finish**.</span></span>

    ![Instalacja została zakończona](aspnet-mvc-4-helpers-forms-and-validation/_static/image25.png)

    <span data-ttu-id="2f4b1-575">*Instalacja została zakończona*</span><span class="sxs-lookup"><span data-stu-id="2f4b1-575">*Installation completed*</span></span>
7. <span data-ttu-id="2f4b1-576">Kliknij przycisk **zakończenia** aby zamknąć Instalatora platformy sieci Web.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-576">Click **Exit** to close Web Platform Installer.</span></span>
8. <span data-ttu-id="2f4b1-577">Aby otworzyć program Visual Studio Express for Web, przejdź do **Start** ekranu i zacznij pisać &quot; **VS Express**&quot;, następnie kliknij polecenie **VS Express for Web** Kafelek.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-577">To open Visual Studio Express for Web, go to the **Start** screen and start writing &quot;**VS Express**&quot;, then click on the **VS Express for Web** tile.</span></span>

    ![VS Express for Web kafelka](aspnet-mvc-4-helpers-forms-and-validation/_static/image26.png)

    <span data-ttu-id="2f4b1-579">*VS Express for Web kafelka*</span><span class="sxs-lookup"><span data-stu-id="2f4b1-579">*VS Express for Web tile*</span></span>

<a id="AppendixB"></a>

<a id="Appendix_B_Using_Code_Snippets"></a>
## <a name="appendix-b-using-code-snippets"></a><span data-ttu-id="2f4b1-580">Dodatek B: korzystania z wstawek kodu</span><span class="sxs-lookup"><span data-stu-id="2f4b1-580">Appendix B: Using Code Snippets</span></span>

<span data-ttu-id="2f4b1-581">Wstawki kodu zapewniają całego kodu, które są potrzebne w zasięgu ręki.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-581">With code snippets, you have all the code you need at your fingertips.</span></span> <span data-ttu-id="2f4b1-582">Dokument laboratorium informuje o dokładnie po ich użycia, jak pokazano na poniższej ilustracji.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-582">The lab document will tell you exactly when you can use them, as shown in the following figure.</span></span>

<span data-ttu-id="2f4b1-583">![Aby wstawić kod do projektu przy użyciu wstawki kodu programu Visual Studio](aspnet-mvc-4-helpers-forms-and-validation/_static/image27.png "wstawki kodu za pomocą programu Visual Studio, aby wstawić kod do projektu")</span><span class="sxs-lookup"><span data-stu-id="2f4b1-583">![Using Visual Studio code snippets to insert code into your project](aspnet-mvc-4-helpers-forms-and-validation/_static/image27.png "Using Visual Studio code snippets to insert code into your project")</span></span>

<span data-ttu-id="2f4b1-584">*Aby wstawić kod do projektu przy użyciu wstawki kodu programu Visual Studio*</span><span class="sxs-lookup"><span data-stu-id="2f4b1-584">*Using Visual Studio code snippets to insert code into your project*</span></span>

<span data-ttu-id="2f4b1-585">***Aby dodać fragment kodu za pomocą klawiatury (C# tylko)***</span><span class="sxs-lookup"><span data-stu-id="2f4b1-585">***To add a code snippet using the keyboard (C# only)***</span></span>

1. <span data-ttu-id="2f4b1-586">Umieść kursor, w którym chcesz wstawić kod.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-586">Place the cursor where you would like to insert the code.</span></span>
2. <span data-ttu-id="2f4b1-587">Zacznij wpisywać nazwę fragment (bez spacji i łączniki).</span><span class="sxs-lookup"><span data-stu-id="2f4b1-587">Start typing the snippet name (without spaces or hyphens).</span></span>
3. <span data-ttu-id="2f4b1-588">Obejrzyj jako IntelliSense wyświetla zgodne z nazwami wstawki.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-588">Watch as IntelliSense displays matching snippets' names.</span></span>
4. <span data-ttu-id="2f4b1-589">Wybierz prawidłowe fragment (lub zachować wpisywanie do momentu wybrania fragment całą nazwę).</span><span class="sxs-lookup"><span data-stu-id="2f4b1-589">Select the correct snippet (or keep typing until the entire snippet's name is selected).</span></span>
5. <span data-ttu-id="2f4b1-590">Naciśnij klawisz Tab dwa razy, aby wstawić fragment kodu w lokalizacji kursora.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-590">Press the Tab key twice to insert the snippet at the cursor location.</span></span>

<span data-ttu-id="2f4b1-591">![Rozpocznij wpisywanie nazwy fragment](aspnet-mvc-4-helpers-forms-and-validation/_static/image28.png "zacznij wpisywać nazwę wstawki programu")</span><span class="sxs-lookup"><span data-stu-id="2f4b1-591">![Start typing the snippet name](aspnet-mvc-4-helpers-forms-and-validation/_static/image28.png "Start typing the snippet name")</span></span>

<span data-ttu-id="2f4b1-592">*Rozpocznij wpisywanie nazwy fragment kodu*</span><span class="sxs-lookup"><span data-stu-id="2f4b1-592">*Start typing the snippet name*</span></span>

<span data-ttu-id="2f4b1-593">![Naciśnij klawisz Tab, aby wybrać wyróżnione fragment](aspnet-mvc-4-helpers-forms-and-validation/_static/image29.png "naciśnij klawisz Tab, aby wybrać wyróżnione fragment kodu")</span><span class="sxs-lookup"><span data-stu-id="2f4b1-593">![Press Tab to select the highlighted snippet](aspnet-mvc-4-helpers-forms-and-validation/_static/image29.png "Press Tab to select the highlighted snippet")</span></span>

<span data-ttu-id="2f4b1-594">*Naciśnij klawisz Tab, aby wybrać wyróżnione fragment kodu*</span><span class="sxs-lookup"><span data-stu-id="2f4b1-594">*Press Tab to select the highlighted snippet*</span></span>

<span data-ttu-id="2f4b1-595">![Ponownie naciśnij klawisz Tab i fragment rozwinie](aspnet-mvc-4-helpers-forms-and-validation/_static/image30.png "rozwinie ponownie naciśnij klawisz Tab i wstawki kodu")</span><span class="sxs-lookup"><span data-stu-id="2f4b1-595">![Press Tab again and the snippet will expand](aspnet-mvc-4-helpers-forms-and-validation/_static/image30.png "Press Tab again and the snippet will expand")</span></span>

<span data-ttu-id="2f4b1-596">*Rozwinie ponownie naciśnij klawisz Tab i wstawki kodu*</span><span class="sxs-lookup"><span data-stu-id="2f4b1-596">*Press Tab again and the snippet will expand*</span></span>

<span data-ttu-id="2f4b1-597">***Aby dodać fragment kodu za pomocą myszy (C#, Visual Basic i XML)*** 1.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-597">***To add a code snippet using the mouse (C#, Visual Basic and XML)*** 1.</span></span> <span data-ttu-id="2f4b1-598">Kliknij prawym przyciskiem myszy, gdy chcesz wstawić fragment kodu.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-598">Right-click where you want to insert the code snippet.</span></span>

1. <span data-ttu-id="2f4b1-599">Wybierz **wstawić fragment** następuje **Moje wstawki kodu**.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-599">Select **Insert Snippet** followed by **My Code Snippets**.</span></span>
2. <span data-ttu-id="2f4b1-600">Wybierz odpowiedni fragment z listy, klikając go.</span><span class="sxs-lookup"><span data-stu-id="2f4b1-600">Pick the relevant snippet from the list, by clicking on it.</span></span>

<span data-ttu-id="2f4b1-601">![Kliknij prawym przyciskiem myszy, gdy chcesz wstawić fragment kodu i wybierz wstawić fragment](aspnet-mvc-4-helpers-forms-and-validation/_static/image31.png "kliknij prawym przyciskiem myszy, gdy chcesz wstawić fragment kodu i wybierz wstawić fragment kodu")</span><span class="sxs-lookup"><span data-stu-id="2f4b1-601">![Right-click where you want to insert the code snippet and select Insert Snippet](aspnet-mvc-4-helpers-forms-and-validation/_static/image31.png "Right-click where you want to insert the code snippet and select Insert Snippet")</span></span>

<span data-ttu-id="2f4b1-602">*Kliknij prawym przyciskiem myszy, gdy chcesz wstawić fragment kodu i wybierz wstawić fragment kodu*</span><span class="sxs-lookup"><span data-stu-id="2f4b1-602">*Right-click where you want to insert the code snippet and select Insert Snippet*</span></span>

<span data-ttu-id="2f4b1-603">![Wybierz odpowiedni fragment z listy, klikając go](aspnet-mvc-4-helpers-forms-and-validation/_static/image32.png "wybierz odpowiedni fragment z listy, klikając go")</span><span class="sxs-lookup"><span data-stu-id="2f4b1-603">![Pick the relevant snippet from the list, by clicking on it](aspnet-mvc-4-helpers-forms-and-validation/_static/image32.png "Pick the relevant snippet from the list, by clicking on it")</span></span>

<span data-ttu-id="2f4b1-604">*Wybierz odpowiedni fragment z listy, klikając go*</span><span class="sxs-lookup"><span data-stu-id="2f4b1-604">*Pick the relevant snippet from the list, by clicking on it*</span></span>
