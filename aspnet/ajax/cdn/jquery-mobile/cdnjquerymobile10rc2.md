...
---
<a name="jquery-mobile-10-rc2-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="f0abc-102">jQuery Mobile 1.0 RC2 w usłudze Microsoft Ajax CDN</span><span class="sxs-lookup"><span data-stu-id="f0abc-102">jQuery Mobile 1.0 RC2 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="f0abc-103">Biblioteka jQuery Mobile 1.0 RC 2 zawiera następujące pliki:</span><span class="sxs-lookup"><span data-stu-id="f0abc-103">The jQuery Mobile 1.0 RC 2 library includes the following files:</span></span>
