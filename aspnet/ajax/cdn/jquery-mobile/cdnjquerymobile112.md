...
ms.locfileid: "41754959"
---
<a name="jquery-mobile-112-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="601d3-102">jQuery Mobile 1.1.2 w usłudze Microsoft Ajax CDN</span><span class="sxs-lookup"><span data-stu-id="601d3-102">jQuery Mobile 1.1.2 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="601d3-103">Biblioteka jQuery Mobile 1.1.2 zawiera następujące pliki:</span><span class="sxs-lookup"><span data-stu-id="601d3-103">The jQuery Mobile 1.1.2 library includes the following files:</span></span>
