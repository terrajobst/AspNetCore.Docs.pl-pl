...
---
<a name="aspnet-web-forms-and-ajax-451"></a><span data-ttu-id="54e52-102">Formularze sieci Web ASP.NET i Ajax 4.5.1</span><span class="sxs-lookup"><span data-stu-id="54e52-102">ASP.NET Web Forms and Ajax 4.5.1</span></span>
====================
<span data-ttu-id="54e52-103">Następujące pliki znajdują się w sieci CDN:</span><span class="sxs-lookup"><span data-stu-id="54e52-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="54e52-104">Uwaga: Skryptów globalizacji, takich jak fr FR.js, można znaleźć w następującym folderze:</span><span class="sxs-lookup"><span data-stu-id="54e52-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
