...
====================
<span data-ttu-id="a0166-103">Następujące pliki znajdują się w sieci CDN:</span><span class="sxs-lookup"><span data-stu-id="a0166-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="a0166-104">Uwaga: Skryptów globalizacji, takich jak fr FR.js, można znaleźć w następującym folderze:</span><span class="sxs-lookup"><span data-stu-id="a0166-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
