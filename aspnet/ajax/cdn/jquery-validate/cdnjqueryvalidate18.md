...
ms.locfileid: "30070449"
---
<a name="jqueryvalidate-version-18"></a><span data-ttu-id="eeac5-102">jquery.Validate wersji 1.8</span><span class="sxs-lookup"><span data-stu-id="eeac5-102">jquery.validate version 1.8</span></span>
====================
<span data-ttu-id="eeac5-103">Następujące pliki znajdują się w sieci CDN:</span><span class="sxs-lookup"><span data-stu-id="eeac5-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="eeac5-104">Lokalizacja plików w https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages \_js ## gdzie ## jest lokalizacja kodu.</span><span class="sxs-lookup"><span data-stu-id="eeac5-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages\_##.js where ## is the loc code.</span></span>
