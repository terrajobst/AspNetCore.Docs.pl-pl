...
ms.locfileid: "30078014"
---
<a name="jqueryvalidate-version-181"></a><span data-ttu-id="112f8-102">Wersja jquery.Validate 1.8.1</span><span class="sxs-lookup"><span data-stu-id="112f8-102">jquery.validate version 1.8.1</span></span>
====================
<span data-ttu-id="112f8-103">Następujące pliki znajdują się w sieci CDN:</span><span class="sxs-lookup"><span data-stu-id="112f8-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="112f8-104">Lokalizacja plików w https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages \_js ## gdzie ## jest lokalizacja kodu.</span><span class="sxs-lookup"><span data-stu-id="112f8-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages\_##.js where ## is the loc code.</span></span>
