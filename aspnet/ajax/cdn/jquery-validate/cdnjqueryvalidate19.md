...
---
<a name="jqueryvalidate-version-19"></a><span data-ttu-id="84ee5-102">Wersja jquery.Validate 1.9</span><span class="sxs-lookup"><span data-stu-id="84ee5-102">jquery.validate version 1.9</span></span>
====================
<span data-ttu-id="84ee5-103">Następujące pliki znajdują się w sieci CDN:</span><span class="sxs-lookup"><span data-stu-id="84ee5-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="84ee5-104">Lokalizacja plików w https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages \_js ## gdzie ## jest lokalizacja kodu.</span><span class="sxs-lookup"><span data-stu-id="84ee5-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages\_##.js where ## is the loc code.</span></span>
