...
ms.locfileid: "30070527"
---
<a name="jquery-validation-1160"></a><span data-ttu-id="fe306-102">Sprawdzanie poprawności 1.16.0 jQuery</span><span class="sxs-lookup"><span data-stu-id="fe306-102">jQuery Validation 1.16.0</span></span>
====================
<span data-ttu-id="fe306-103">Następujące pliki znajdują się w sieci CDN:</span><span class="sxs-lookup"><span data-stu-id="fe306-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="fe306-104">Lokalizacja plików w https://ajax.aspnetcdn.com/ajax/jquery.validate/1.16.0/localization/messages \_js ## gdzie ## jest lokalizacja kodu.</span><span class="sxs-lookup"><span data-stu-id="fe306-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.16.0/localization/messages\_##.js where ## is the loc code.</span></span>
