...
ms.locfileid: "37401112"
---
<a name="jquery-validation-1130"></a><span data-ttu-id="5a34c-102">Sprawdzanie poprawności 1.13.0 jQuery</span><span class="sxs-lookup"><span data-stu-id="5a34c-102">jQuery Validation 1.13.0</span></span>
====================
<span data-ttu-id="5a34c-103">Następujące pliki znajdują się w sieci CDN:</span><span class="sxs-lookup"><span data-stu-id="5a34c-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="5a34c-104">Lokalizacja plików w https://ajax.aspnetcdn.com/ajax/jquery.validate/1.13.0/localization/messages\_##.js gdzie ## znajduje się kod lokalizacja.</span><span class="sxs-lookup"><span data-stu-id="5a34c-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.13.0/localization/messages\_##.js where ## is the loc code.</span></span>
