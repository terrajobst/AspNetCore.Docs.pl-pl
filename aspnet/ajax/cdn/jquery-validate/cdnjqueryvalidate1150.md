...
---
<a name="jquery-validation-1150"></a><span data-ttu-id="b202d-102">Sprawdzanie poprawności 1.15.0 jQuery</span><span class="sxs-lookup"><span data-stu-id="b202d-102">jQuery Validation 1.15.0</span></span>
====================
<span data-ttu-id="b202d-103">Następujące pliki znajdują się w sieci CDN:</span><span class="sxs-lookup"><span data-stu-id="b202d-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="b202d-104">Lokalizacja plików w https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.0/localization/messages\_##.js gdzie ## znajduje się kod lokalizacja.</span><span class="sxs-lookup"><span data-stu-id="b202d-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.0/localization/messages\_##.js where ## is the loc code.</span></span>
