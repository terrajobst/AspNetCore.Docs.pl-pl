...
ms.locfileid: "30071960"
---
<a name="jquery-validation-1100"></a><span data-ttu-id="13038-102">Sprawdzanie poprawności 1.10.0 jQuery</span><span class="sxs-lookup"><span data-stu-id="13038-102">jQuery Validation 1.10.0</span></span>
====================
<span data-ttu-id="13038-103">Następujące pliki znajdują się w sieci CDN:</span><span class="sxs-lookup"><span data-stu-id="13038-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="13038-104">Lokalizacja plików w https://ajax.aspnetcdn.com/ajax/jquery.validate/1.10.0/localization/messages \_js ## gdzie ## jest lokalizacja kodu.</span><span class="sxs-lookup"><span data-stu-id="13038-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.10.0/localization/messages\_##.js where ## is the loc code.</span></span>
