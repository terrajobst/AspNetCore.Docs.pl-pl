...
====================
> [!WARNING]
> Aplikacje produkcyjne nie powinna przyjmować twardych zależności na zasoby sieci CDN. Aplikacje powinny testu dla zasobów sieci CDN w warstwie, do których odwołuje się i użyj rezerwowy zasobów, jeśli element CDN jest niedostępny. 
>
> Usługa Microsoft Ajax CDN ma umowy dotyczącej poziomu usług niż przy użyciu usługi Azure CDN.
>
> Użyj [ten problem GitHub](https://github.com/aspnet/Docs/issues/5832) na zgłaszanie problemów z usługi Microsoft Ajax CDN.
