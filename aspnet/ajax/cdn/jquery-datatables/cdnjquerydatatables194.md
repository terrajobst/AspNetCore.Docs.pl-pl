...
ms.locfileid: "30071197"
---
<a name="jquery-datatables-194"></a><span data-ttu-id="b4974-102">jQuery DataTables pytanie 1.9.4</span><span class="sxs-lookup"><span data-stu-id="b4974-102">jQuery DataTables 1.9.4</span></span>
====================
<span data-ttu-id="b4974-103">Następujące pliki jquery wtyczek DataTables znajdują się w sieci CDN:</span><span class="sxs-lookup"><span data-stu-id="b4974-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
