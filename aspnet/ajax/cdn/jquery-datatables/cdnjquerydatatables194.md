...
ms.locfileid: "41753505"
---
<a name="jquery-datatables-194"></a><span data-ttu-id="e0f05-102">jQuery DataTables pytanie 1.9.4</span><span class="sxs-lookup"><span data-stu-id="e0f05-102">jQuery DataTables 1.9.4</span></span>
====================
<span data-ttu-id="e0f05-103">Następujące pliki w bibliotece jQuery wtyczek DataTable znajdują się w sieci CDN:</span><span class="sxs-lookup"><span data-stu-id="e0f05-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
