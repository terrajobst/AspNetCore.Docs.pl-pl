...
ms.locfileid: "37818181"
---
<a name="jquery-datatables-1105"></a><span data-ttu-id="f1e5a-102">jQuery DataTables 1.10.5</span><span class="sxs-lookup"><span data-stu-id="f1e5a-102">jQuery DataTables 1.10.5</span></span>
====================
<span data-ttu-id="f1e5a-103">Następujące pliki w bibliotece jQuery wtyczek DataTable znajdują się w sieci CDN:</span><span class="sxs-lookup"><span data-stu-id="f1e5a-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
