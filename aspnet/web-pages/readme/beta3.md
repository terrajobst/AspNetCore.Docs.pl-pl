...
> <span data-ttu-id="0bfef-127">Zobacz [szczegółowe instrukcje dotyczące publikowania aplikacji](https://go.microsoft.com/fwlink/?LinkID=196149)</span><span class="sxs-lookup"><span data-stu-id="0bfef-127">See [Step-by-Step Instructions for Publishing Applications](https://go.microsoft.com/fwlink/?LinkID=196149)</span></span>
...
> 
> <span data-ttu-id="0bfef-180">Na przykład następująca `@helper` składni działa w wersji Beta 3:</span><span class="sxs-lookup"><span data-stu-id="0bfef-180">For example, the following `@helper` syntax works in the Beta 3 release:</span></span>
> 
...
#### <a name="issue-unexpected-behavior-when-using-a-custom-user-table-for-membership"></a><span data-ttu-id="0bfef-211">Problem: Nieoczekiwane zachowanie w przypadku używania tabeli użytkownika niestandardowego dla członkostwa</span><span class="sxs-lookup"><span data-stu-id="0bfef-211">Issue: Unexpected behavior when using a custom user table for membership</span></span>
...
> <span data-ttu-id="0bfef-231">Instalowanie składnika ASP.NET Web Pages nie także zainstalować narzędzia dla programu Visual Studio takie jak IntelliSense oraz szablony projektów dla aplikacji ASP.NET Web Pages.</span><span class="sxs-lookup"><span data-stu-id="0bfef-231">Installing ASP.NET Web Pages does not also install tools for Visual Studio such as IntelliSense and project templates for ASP.NET Web Pages applications.</span></span>
> 
...
> <span data-ttu-id="0bfef-274">W usługach IIS 7 lub usług IIS 7.5 żądań z adresu URL podobnie do poniższego nie będą mogli odnaleźć strony, które mają *.cshtml* lub *.vbhtml* rozszerzenia:</span><span class="sxs-lookup"><span data-stu-id="0bfef-274">On IIS 7 or IIS 7.5, requests with a URL like the following are not able to find pages that have the *.cshtml* or *.vbhtml* extension:</span></span>  
> 
...
> <span data-ttu-id="0bfef-333">**Obejście problemu**</span><span class="sxs-lookup"><span data-stu-id="0bfef-333">**Workaround**</span></span>  
...
>   
> [<span data-ttu-id="0bfef-383">Aplikacja, która jest uruchamiana przez użytkowników innych niż administracyjne nie może nasłuchiwać na ruch HTTP, komputera, na którym aplikacja jest uruchomiona w Windows Vista, Windows Server 2003 lub Windows XP.</span><span class="sxs-lookup"><span data-stu-id="0bfef-383">An application that is started by a non-administrative user cannot listen to the HTTP traffic of the computer on which the application is running in Windows Vista, Windows Server 2003, or Windows XP.</span></span>](https://support.microsoft.com/kb/939786)


#### <a name="issue-google-chrome-is-not-available-as-a-run-option"></a><span data-ttu-id="0bfef-384">Problem: Google Chrome nie jest dostępna jako opcja wykonywania</span><span class="sxs-lookup"><span data-stu-id="0bfef-384">Issue: Google Chrome is not available as a Run option</span></span>

> <span data-ttu-id="0bfef-385">Google Chrome nie jest wyświetlana na liście przeglądarek, w obszarze **Uruchom** na **Home** kartę.</span><span class="sxs-lookup"><span data-stu-id="0bfef-385">Google Chrome is not displayed in the list of browsers under **Run** on the **Home** tab.</span></span>
> 
> <span data-ttu-id="0bfef-386">**Obejście problemu**</span><span class="sxs-lookup"><span data-stu-id="0bfef-386">**Workaround**</span></span>  
> <span data-ttu-id="0bfef-387">Niektóre wersje programu Google Chrome nie rejestrują się prawidłowo z tej funkcji domyślne programy w programie Windows.</span><span class="sxs-lookup"><span data-stu-id="0bfef-387">Some versions of Google Chrome do not register themselves correctly with the Default Programs feature in Windows.</span></span> <span data-ttu-id="0bfef-388">Obejść ten problem, uruchom program Google Chrome, kliknij przycisk *dostosowywanie i kontroli Google Chrome* menu, kliknij przycisk *opcje*, a następnie kliknij przycisk *upewnij Google Chrome w mojej przeglądarce domyślnej*.</span><span class="sxs-lookup"><span data-stu-id="0bfef-388">As a workaround, start Google Chrome, click the *Customize and control Google Chrome* menu, click *Options*, and then click *Make Google Chrome my default browser*.</span></span>


#### <a name="issue-the-foreign-key-dialog-box-doesnt-allow-entering-a-primary-key"></a><span data-ttu-id="0bfef-389">Problem: Okno dialogowe "Klucz obcy" nie zezwala na wprowadzanie klucza podstawowego</span><span class="sxs-lookup"><span data-stu-id="0bfef-389">Issue: The "Foreign Key" dialog box doesn't allow entering a primary key</span></span>

> <span data-ttu-id="0bfef-390">**Klucz obcy** okno dialogowe pozwala na wprowadzanie nazwy klucza podstawowego z tabeli klucza podstawowego.</span><span class="sxs-lookup"><span data-stu-id="0bfef-390">The **Foreign Key** dialog box does not allow you to enter the primary key name from the primary key table.</span></span>
> 
> <span data-ttu-id="0bfef-391">**Obejście problemu**</span><span class="sxs-lookup"><span data-stu-id="0bfef-391">**Workaround**</span></span>  
> <span data-ttu-id="0bfef-392">Jest to zamierzone.</span><span class="sxs-lookup"><span data-stu-id="0bfef-392">This is intentional.</span></span> <span data-ttu-id="0bfef-393">Nie musisz wprowadzić nazwę klucza podstawowego z tabeli klucza podstawowego.</span><span class="sxs-lookup"><span data-stu-id="0bfef-393">You do not need to enter the name of the primary key from the primary key table.</span></span>


#### <a name="issue-the-relationships-button-is-disabled"></a><span data-ttu-id="0bfef-394">Problem: Przycisk "Relacji" jest wyłączony.</span><span class="sxs-lookup"><span data-stu-id="0bfef-394">Issue: The "Relationships" button is disabled</span></span>

> <span data-ttu-id="0bfef-395">**Relacje** przycisku w obszarze **tabeli** karcie **baz danych** obszar roboczy jest wyłączona w przypadku baz danych programu SQL Server Compact.</span><span class="sxs-lookup"><span data-stu-id="0bfef-395">The **Relationships** button under the **Table** tab in the **Databases** workspace is disabled for SQL Server Compact databases.</span></span>
> 
> <span data-ttu-id="0bfef-396">**Obejście problemu**</span><span class="sxs-lookup"><span data-stu-id="0bfef-396">**Workaround**</span></span>  
> <span data-ttu-id="0bfef-397">Brak.</span><span class="sxs-lookup"><span data-stu-id="0bfef-397">None.</span></span> <span data-ttu-id="0bfef-398">SQL Server Compact nie obsługuje relacje między tabelami.</span><span class="sxs-lookup"><span data-stu-id="0bfef-398">SQL Server Compact does not support relationships between tables.</span></span>


#### <a name="issue-parameterized-sql-queries-throw-exceptions"></a><span data-ttu-id="0bfef-399">Problem: Zapytania SQL — sparametryzowane zgłaszanie wyjątków</span><span class="sxs-lookup"><span data-stu-id="0bfef-399">Issue: Parameterized SQL queries throw exceptions</span></span>

> <span data-ttu-id="0bfef-400">W SQL Server Compact 4.0, jeśli nie określisz typ danych takich jak `SqlDbType` lub `DbType` parametrów w zapytaniach parametrycznych, zgłaszany jest wyjątek podczas wykonywania kwerendy.</span><span class="sxs-lookup"><span data-stu-id="0bfef-400">In SQL Server Compact 4.0, if you do not specify a data type such as `SqlDbType` or `DbType` for parameters in parameterized queries, an exception is thrown when the query runs.</span></span>
> 
> <span data-ttu-id="0bfef-401">**Obejście problemu**</span><span class="sxs-lookup"><span data-stu-id="0bfef-401">**Workaround**</span></span>  
> <span data-ttu-id="0bfef-402">Jawnie ustawić typ danych dla parametrów, takich jak `SqlDbType` lub `DbType`.</span><span class="sxs-lookup"><span data-stu-id="0bfef-402">Explicitly set the data type for parameters such as `SqlDbType` or `DbType`.</span></span> <span data-ttu-id="0bfef-403">Jest to istotne w przypadku typów danych obiektów BLOB (`image` i `ntext`).</span><span class="sxs-lookup"><span data-stu-id="0bfef-403">This is critical in the case of BLOB data types (`image` and `ntext`).</span></span> <span data-ttu-id="0bfef-404">Należy użyć kodu, jak pokazano poniżej:</span><span class="sxs-lookup"><span data-stu-id="0bfef-404">Use code like the following:</span></span>
> 
...
## <a name="for-more-information"></a><span data-ttu-id="0bfef-405">Aby uzyskać więcej informacji</span><span class="sxs-lookup"><span data-stu-id="0bfef-405">For More Information</span></span>

<span data-ttu-id="0bfef-406">Aby uzyskać więcej informacji na temat programu WebMatrix w wersji Beta 3 zobacz następujące witryny sieci Web:</span><span class="sxs-lookup"><span data-stu-id="0bfef-406">For more information about WebMatrix Beta 3, see the following websites:</span></span>

- [<span data-ttu-id="0bfef-407">IIS.net</span><span class="sxs-lookup"><span data-stu-id="0bfef-407">IIS.net</span></span>](http://iis.net/)
- [<span data-ttu-id="0bfef-408">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="0bfef-408">ASP.NET</span></span>](https://asp.net/webmatrix)
- [<span data-ttu-id="0bfef-409">Microsoft.com/web</span><span class="sxs-lookup"><span data-stu-id="0bfef-409">Microsoft.com/web</span></span>](https://www.microsoft.com/web)

* * *

<span data-ttu-id="0bfef-410">© 2010 Microsoft Corporation.</span><span class="sxs-lookup"><span data-stu-id="0bfef-410">© 2010 Microsoft Corporation.</span></span> <span data-ttu-id="0bfef-411">Wszelkie prawa zastrzeżone.</span><span class="sxs-lookup"><span data-stu-id="0bfef-411">All Rights Reserved.</span></span> <span data-ttu-id="0bfef-412">[Warunki użytkowania](https://msdn.microsoft.cos/cc300389.aspx).</span><span class="sxs-lookup"><span data-stu-id="0bfef-412">[Terms of Use](https://msdn.microsoft.cos/cc300389.aspx).</span></span>
