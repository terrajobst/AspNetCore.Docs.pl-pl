...
> <span data-ttu-id="5e19c-129">Zobacz [szczegółowe instrukcje dotyczące publikowania aplikacji](https://go.microsoft.com/fwlink/?LinkID=196149)</span><span class="sxs-lookup"><span data-stu-id="5e19c-129">See [Step-by-Step Instructions for Publishing Applications](https://go.microsoft.com/fwlink/?LinkID=196149)</span></span>
...
> <span data-ttu-id="5e19c-221">Instalowanie składnika ASP.NET Web Pages nie także zainstalować narzędzia dla programu Visual Studio takie jak IntelliSense oraz szablony projektów dla aplikacji ASP.NET Web Pages.</span><span class="sxs-lookup"><span data-stu-id="5e19c-221">Installing ASP.NET Web Pages does not also install tools for Visual Studio such as IntelliSense and project templates for ASP.NET Web Pages applications.</span></span>
> 
...
> 
> - <span data-ttu-id="5e19c-296">W Windows Vista lub Windows 7 włączenie funkcji Kontrola konta użytkownika.</span><span class="sxs-lookup"><span data-stu-id="5e19c-296">On Windows Vista or Windows 7, enable UAC.</span></span>
...
> <span data-ttu-id="5e19c-308">**Klucz obcy** okno dialogowe pozwala na wprowadzanie nazwy klucza podstawowego z tabeli klucza podstawowego.</span><span class="sxs-lookup"><span data-stu-id="5e19c-308">The **Foreign Key** dialog box does not allow you to enter the primary key name from the primary key table.</span></span>
> 
...
> 
> <span data-ttu-id="5e19c-322">**Obejście problemu** </span><span class="sxs-lookup"><span data-stu-id="5e19c-322">**Workaround** </span></span>  
...
> <span data-ttu-id="5e19c-356">W niektórych okolicznościach publikowania aplikacji powoduje wystąpienie błędu "Usługa jest niedostępna".</span><span class="sxs-lookup"><span data-stu-id="5e19c-356">Under some circumstances, publishing an application causes a "service is unavailable" error.</span></span>
> 
...
#### <a name="issue-some-links-are-not-visible-in-dotnetnuke-after-publishing-or-downloading-the-site"></a><span data-ttu-id="5e19c-394">Problem: Niektóre łącza nie są widoczne w DotNetNuke po publikacji lub pobierania witryny</span><span class="sxs-lookup"><span data-stu-id="5e19c-394">Issue: Some links are not visible in DotNetNuke after publishing or downloading the site</span></span>

> <span data-ttu-id="5e19c-395">Jeśli publikowanie lub pobrać witryny DotNetNuke, może być konieczne wyczyszczenie pamięci podręcznej, aby uzyskać nowe linki, które ma być wyświetlana w witrynie.</span><span class="sxs-lookup"><span data-stu-id="5e19c-395">If you publish or download a DotNetNuke site, you might need to clear the cache to get the new links to appear on the site.</span></span>
> 
> <span data-ttu-id="5e19c-396">**Obejście problemu**</span><span class="sxs-lookup"><span data-stu-id="5e19c-396">**Workaround**</span></span>
> 
> 1. <span data-ttu-id="5e19c-397">Zaloguj się jako "Host".</span><span class="sxs-lookup"><span data-stu-id="5e19c-397">Log in as "Host".</span></span>
> 2. <span data-ttu-id="5e19c-398">Przejdź do menu hosta i wybierz **ustawienia hosta**.</span><span class="sxs-lookup"><span data-stu-id="5e19c-398">Go to the host menu and select **Host Settings**.</span></span>
> 3. <span data-ttu-id="5e19c-399">Przewiń w dół i w obszarze **Zaawansowane ustawienia**, rozwiń węzeł **ustawienia wydajności**.</span><span class="sxs-lookup"><span data-stu-id="5e19c-399">Scroll down and under **Advanced Settings**, expand **Performance Settings**.</span></span>
> 4. <span data-ttu-id="5e19c-400">Kliknij przycisk **Wyczyść pamięć podręczną** link do strony.</span><span class="sxs-lookup"><span data-stu-id="5e19c-400">Click the **Clear Cache** link for pages.</span></span>
> 5. <span data-ttu-id="5e19c-401">Przejdź do dolnej części strony i ponownym uruchomieniu aplikacji.</span><span class="sxs-lookup"><span data-stu-id="5e19c-401">Go to the bottom of the page and restart the application.</span></span>


#### <a name="issue-some-links-in-atomsite-are-broken-after-you-download-a-published-site"></a><span data-ttu-id="5e19c-402">Problem: Niektóre linki w program AtomSite nie działają po pobraniu opublikowanej witryny</span><span class="sxs-lookup"><span data-stu-id="5e19c-402">Issue: Some links in AtomSite are broken after you download a published site</span></span>

> <span data-ttu-id="5e19c-403">**Obejście problemu**</span><span class="sxs-lookup"><span data-stu-id="5e19c-403">**Workaround**</span></span>  
> <span data-ttu-id="5e19c-404">W *service.config* pliku *users.config* pliku i wszystkie *.xml* pliki, Zastąp ciąg adresu URL (na przykład `http://myhost.com/atomsite`) przy użyciu lokalnego (na przykład `http://localhost:1239`).</span><span class="sxs-lookup"><span data-stu-id="5e19c-404">In the *service.config* file, *users.config* file, and all *.xml* files, replace the URL string (for example, `http://myhost.com/atomsite`) with the local one (for example, `http://localhost:1239`).</span></span>


#### <a name="issue-mysql-based-applications-like-wordpress-fail-to-publish-and-report-a-database-error"></a><span data-ttu-id="5e19c-405">Problem: Aplikacji takich jak WordPress z MySQL nie można opublikować i zgłoś błąd bazy danych</span><span class="sxs-lookup"><span data-stu-id="5e19c-405">Issue: MySQL-based applications like WordPress fail to publish and report a database error</span></span>

> <span data-ttu-id="5e19c-406">Domyślnie program WebMatrix instaluje MySQL z zestawem znaków UTF-8.</span><span class="sxs-lookup"><span data-stu-id="5e19c-406">By default, WebMatrix installs MySQL with the UTF-8 character set.</span></span> <span data-ttu-id="5e19c-407">Jeśli instalowanie bazy danych MySQL na własną rękę, a nie jest zestaw znaków UTF-8 (na przykład jest Latin1), proces publikowania dla baz danych może zakończyć się niepowodzeniem.</span><span class="sxs-lookup"><span data-stu-id="5e19c-407">If you install MySQL on your own, and the character set is not UTF-8 (for example, it is Latin1), the publish process for databases might fail.</span></span>
> 
> <span data-ttu-id="5e19c-408">**Obejście problemu**</span><span class="sxs-lookup"><span data-stu-id="5e19c-408">**Workaround**</span></span>
> 
> 1. <span data-ttu-id="5e19c-409">Zmień zestaw MySQL na UTF-8 znaków.</span><span class="sxs-lookup"><span data-stu-id="5e19c-409">Change the character set for MySQL to UTF-8.</span></span> <span data-ttu-id="5e19c-410">(Aby uzyskać więcej informacji, zobacz [zestaw znaków serwera i sortowania](http://dev.mysql.com/doc/refman/5.0/en/charset-server.html) w witrynie internetowej MySQL.)</span><span class="sxs-lookup"><span data-stu-id="5e19c-410">(For details, see [Server Character Set and Collation](http://dev.mysql.com/doc/refman/5.0/en/charset-server.html) on the MySQL website.)</span></span>
> 2. <span data-ttu-id="5e19c-411">Zainstaluj aplikację.</span><span class="sxs-lookup"><span data-stu-id="5e19c-411">Reinstall the application.</span></span>
> 3. <span data-ttu-id="5e19c-412">Ponownie opublikować aplikację.</span><span class="sxs-lookup"><span data-stu-id="5e19c-412">Republish the application.</span></span>


#### <a name="issue-download-published-site-fails-for-applications-that-have-browser-based-setup"></a><span data-ttu-id="5e19c-413">Problem: "Pobierania opublikowano witrynę" kończy się niepowodzeniem dla aplikacji, które skonfigurowano oparte na przeglądarce</span><span class="sxs-lookup"><span data-stu-id="5e19c-413">Issue: "Download published site" fails for applications that have browser-based setup</span></span>

> <span data-ttu-id="5e19c-414">Niektóre aplikacje (na przykład Kentico CMS) wymagane jest ich uruchamiania w przeglądarce, aby można było wykonać po instalacji, takich jak tworzenie bazy danych.</span><span class="sxs-lookup"><span data-stu-id="5e19c-414">Some applications (for example, Kentico CMS) require you to launch them in the browser in order to perform post-installation setup such as creating a database.</span></span> <span data-ttu-id="5e19c-415">Jeśli spróbujesz opublikować aplikację tak, nie kończą działania Instalatora opartego na przeglądarce, próby pobrania tej samej lokacji z serwera zdalnego nie powiedzie się.</span><span class="sxs-lookup"><span data-stu-id="5e19c-415">If you publish an application like this without completing the browser-based setup, attempting to download the same site from a remote server will fail.</span></span>
> 
> <span data-ttu-id="5e19c-416">**Obejście problemu**</span><span class="sxs-lookup"><span data-stu-id="5e19c-416">**Workaround**</span></span>  
> <span data-ttu-id="5e19c-417">Zakończ Instalatora opartego na przeglądarce, przed opublikowaniem w witrynie.</span><span class="sxs-lookup"><span data-stu-id="5e19c-417">Finish browser-based setup before publishing the site.</span></span>


#### <a name="issue-download-published-site-fails-with-a-database-error-for-dotnetnuke-and-kooboo-cms"></a><span data-ttu-id="5e19c-418">Problem: "Pobierania opublikowano witrynę" nie powiedzie się z powodu błędu bazy danych DotNetNuke i Kooboo CMS</span><span class="sxs-lookup"><span data-stu-id="5e19c-418">Issue: "Download published site" fails with a database error for DotNetNuke and Kooboo CMS</span></span>

> <span data-ttu-id="5e19c-419">Jeśli spróbujesz pobrać aplikację z serwera i poświadczenia administratora w parametrach połączenia bazy danych w **ustawień publikowania** okno dialogowe, może się pojawić następujący błąd w dzienniku publikowania:</span><span class="sxs-lookup"><span data-stu-id="5e19c-419">If you try to download an application from a server and you have administrator credentials in the database connection string in the **Publish Settings** dialog, you might see the following error in the publish log:</span></span>
> 
> [!code-console[Main](overview/samples/sample9.cmd)]
> 
> <span data-ttu-id="5e19c-420">**Obejście problemu**</span><span class="sxs-lookup"><span data-stu-id="5e19c-420">**Workaround**</span></span>  
> <span data-ttu-id="5e19c-421">Jeśli jest to praktyczne, ponownie opublikować witryny (lub opublikować) przy użyciu poświadczeń bez uprawnień administratora dla bazy danych.</span><span class="sxs-lookup"><span data-stu-id="5e19c-421">If practical, republish the site (or have it published) using non-administrator credentials for the database.</span></span>


<a id="More_Info"></a>

## <a name="for-more-information"></a><span data-ttu-id="5e19c-422">Aby uzyskać więcej informacji</span><span class="sxs-lookup"><span data-stu-id="5e19c-422">For More Information</span></span>

<span data-ttu-id="5e19c-423">Aby uzyskać więcej informacji na temat programu WebMatrix w wersji 1.0 zobacz następujące witryny sieci Web:</span><span class="sxs-lookup"><span data-stu-id="5e19c-423">For more information about WebMatrix 1.0, see the following websites:</span></span>

- [<span data-ttu-id="5e19c-424">IIS.net</span><span class="sxs-lookup"><span data-stu-id="5e19c-424">IIS.net</span></span>](http://iis.net/)
- [<span data-ttu-id="5e19c-425">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="5e19c-425">ASP.NET</span></span>](https://asp.net/webmatrix)
- [<span data-ttu-id="5e19c-426">Microsoft.com/web</span><span class="sxs-lookup"><span data-stu-id="5e19c-426">Microsoft.com/web</span></span>](https://www.microsoft.com/web)

<span data-ttu-id="5e19c-427">© 2011 Microsoft Corporation.</span><span class="sxs-lookup"><span data-stu-id="5e19c-427">© 2011 Microsoft Corporation.</span></span> <span data-ttu-id="5e19c-428">Wszelkie prawa zastrzeżone.</span><span class="sxs-lookup"><span data-stu-id="5e19c-428">All Rights Reserved.</span></span> <span data-ttu-id="5e19c-429">[Warunki użytkowania](https://msdn.microsoft.cos/cc300389.aspx).</span><span class="sxs-lookup"><span data-stu-id="5e19c-429">[Terms of Use](https://msdn.microsoft.cos/cc300389.aspx).</span></span>
