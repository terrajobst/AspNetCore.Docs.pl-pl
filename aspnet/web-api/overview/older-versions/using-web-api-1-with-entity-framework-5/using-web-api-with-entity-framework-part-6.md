...
- Firma Microsoft kwerendy bazy danych dla zlecenia, używamy [DbQuery.Include](https://msdn.microsoft.com/en-us/library/gg696395) metodę, aby pobrać pokrewny `OrderDetail` i `Product` jednostek.
