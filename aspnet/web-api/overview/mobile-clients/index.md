...
====================
> Przy użyciu interfejsu API sieci Web platformy ASP.NET do natywnej klientów mobilnych.


- [Wywołanie interfejsu API sieci Web z aplikacji Windows Phone 8 (C#)](calling-web-api-from-a-windows-phone-8-application.md)
