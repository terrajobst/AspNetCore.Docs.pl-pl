...
W tym samouczku użyjesz internetowego interfejsu API platformy ASP.NET do utworzenia internetowego interfejsu API, który zwraca listę produktów. Na stronie internetowej frontonu do wyświetlania wyników jest używana technologia jQuery.
