...
====================
> Sposób obsługi wyjątków w interfejsie API sieci Web ASP.NET.


- [Obsługa wyjątków w interfejsu API sieci Web](exception-handling.md)
- [Globalne obsługi błędów w składniku Web API 2](web-api-global-error-handling.md)
