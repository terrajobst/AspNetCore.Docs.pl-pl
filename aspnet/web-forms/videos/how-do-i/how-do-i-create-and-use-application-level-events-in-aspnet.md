...
To wideo Pels Krzysztof będzie pokazują, jak utworzyć plik klasy aplikacji (pliku Global.asax) zawierającej obsługę zdarzeń poziomu aplikacji, takie jak aplikacja\_Start i aplikacja\_powstaniem zdarzenia BeginRequest. Następnie sekwencja zdarzeń na poziomie aplikacji w cyklu życia aplikacji zostanie omówiony jako podstawę do ustalenia, gdzie będzie najlepsza niektóre rodzaje operacji wykonywanych podczas cyklu życia aplikacji.

[&#9654; Obejrzyj klip wideo (minuty 12)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-create-and-use-application-level-events-in-aspnet)
