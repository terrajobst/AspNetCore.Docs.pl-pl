...
---
<a name="how-do-i-retrieve-values-from-server-side-ajax-controls"></a>[Jak i.] Pobieranie wartości z kontrolki AJAX po stronie serwera
====================
przez [Stagner Jan](https://github.com/JoeStagner)

W tym wideo I będzie pokazują, jak można pobrać wartości z kontrolki AJAX po stronie serwera, takich jak te znaleziono w zestawie narzędzi programu AJAX.

[&#9654;Obejrzyj klip wideo (minuty 8)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-retrieve-values-from-server-side-ajax-controls)
