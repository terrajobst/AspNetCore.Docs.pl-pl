...
---
<a name="how-do-i-create-excel-spreadsheets-using-linq-to-xml"></a>[Jak i.] Tworzenie arkuszy programu Excel za pomocą LINQ do XML?
====================
przez [Massi Anna](https://github.com/bethmassi)

Deweloperów języka Visual Basic będzie Dowiedz się, jak wykonać zapytanie ich bazy danych programu SQL Server, aby można było łatwo utworzyć arkusze programu Excel bezpośrednio w edytorze programu Visual Basic, za pomocą LINQ do XML.

[&#9654;Obejrzyj klip wideo (10 minut)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-create-excel-spreadsheets-using-linq-to-xml)
