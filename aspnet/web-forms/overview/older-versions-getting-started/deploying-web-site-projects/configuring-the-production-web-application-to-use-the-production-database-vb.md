...
ms.locfileid: "41754219"
---
<a name="configuring-the-production-web-application-to-use-the-production-database-vb"></a>Konfigurowanie produkcyjnej aplikacji internetowej do użycia z produkcyjnej bazy danych (VB)
====================
