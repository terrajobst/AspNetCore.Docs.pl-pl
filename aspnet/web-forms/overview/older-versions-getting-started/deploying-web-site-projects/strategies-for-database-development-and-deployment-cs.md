...
ms.locfileid: "37823673"
---
<a name="strategies-for-database-development-and-deployment-c"></a>Strategie projektowania baz danych i wdrażania (C#)
====================
...
**Rysunek 1**: porównanie programowania i produkcyjnych bazach danych ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](strategies-for-database-development-and-deployment-cs/_static/image3.jpg))
