...
ms.locfileid: "30888295"
---
<a name="users-and-roles-on-the-production-website-c"></a>Użytkownicy i role w środowisku produkcyjnym w sieci Web (C#)
====================
...
W [ *Konfigurowanie witryny sieci Web czy korzysta z usługi aplikacji* samouczek](configuring-a-website-that-uses-application-services-cs.md) dodano stronę, aby `Admin` folder o nazwie `CreateAccount.aspx`. Ta strona umożliwia administratorem, aby dodać nowe konto użytkownika do witryny i określ, czy nowo utworzony użytkownik jest w roli administratora (zobacz **rysunek 5**).
