...
**Rysunek 02**: Dodawanie formantu ContentPlaceHolder kolumnę po lewej stronie strony wzorcowej ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](multiple-contentplaceholders-and-default-content-vb/_static/image6.png))
...
**Rysunek 03**: po lewej stronie kolumny teraz obejmuje specyficzne dla strony zawartości poniżej sekcji wiadomości ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](multiple-contentplaceholders-and-default-content-vb/_static/image9.png))
...
**Rysunek 05**: Brak zawartości nie jest renderowany `LeftColumnContent` ContentPlaceHolder ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](multiple-contentplaceholders-and-default-content-vb/_static/image15.png))
...
**Rysunek 08**: domyślna zawartości dla `LeftColumnContent` i `QuickLoginUI` kontrolek ContentPlaceHolder są wyświetlane ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](multiple-contentplaceholders-and-default-content-vb/_static/image24.png))
