...
## <a name="improvements-in-the-code-behind-model"></a><span data-ttu-id="4a8b5-112">Ulepszenia w modelu związanym z kodem</span><span class="sxs-lookup"><span data-stu-id="4a8b5-112">Improvements in the Code-Behind Model</span></span>
...
## <a name="enabletheming"></a><span data-ttu-id="4a8b5-163">EnableTheming</span><span class="sxs-lookup"><span data-stu-id="4a8b5-163">EnableTheming</span></span>
...
<span data-ttu-id="4a8b5-178">Ten atrybut określa plik strony głównej dla bieżącej strony.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-178">This attribute specifies the master page file for the current page.</span></span> <span data-ttu-id="4a8b5-179">Ścieżka może być względna lub bezwzględna.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-179">The path can be relative or absolute.</span></span> <span data-ttu-id="4a8b5-180">Strony wzorcowe są objęte [modułu 4](master-pages.md).</span><span class="sxs-lookup"><span data-stu-id="4a8b5-180">Master pages are covered in [Module 4](master-pages.md).</span></span>
...
## <a name="setting-public-property-values-via-the--page-directive"></a><span data-ttu-id="4a8b5-194">Ustawianie wartości właściwości publicznej za pośrednictwem @ Page — dyrektywa</span><span class="sxs-lookup"><span data-stu-id="4a8b5-194">Setting Public Property Values via the @ Page Directive</span></span>
...
## <a name="enableeventvalidation"></a><span data-ttu-id="4a8b5-219">EnableEventValidation</span><span class="sxs-lookup"><span data-stu-id="4a8b5-219">EnableEventValidation</span></span>
...
## <a name="isasync"></a><span data-ttu-id="4a8b5-232">IsAsync</span><span class="sxs-lookup"><span data-stu-id="4a8b5-232">IsAsync</span></span>
...
## <a name="master"></a><span data-ttu-id="4a8b5-247">Wzorzec</span><span class="sxs-lookup"><span data-stu-id="4a8b5-247">Master</span></span>
...
## <a name="skinid"></a><span data-ttu-id="4a8b5-260">SkinID</span><span class="sxs-lookup"><span data-stu-id="4a8b5-260">SkinID</span></span>
...
## <a name="new-protected-properties-of-the-page-class"></a><span data-ttu-id="4a8b5-274">Nowe właściwości chronionego klasy strony</span><span class="sxs-lookup"><span data-stu-id="4a8b5-274">New Protected Properties of the Page Class</span></span>
...
## <a name="uniquefilepathsuffix"></a><span data-ttu-id="4a8b5-287">UniqueFilePathSuffix</span><span class="sxs-lookup"><span data-stu-id="4a8b5-287">UniqueFilePathSuffix</span></span>
...
## <a name="initcomplete-new-in-20"></a><span data-ttu-id="4a8b5-325">InitComplete (Nowość w wersji 2.0)</span><span class="sxs-lookup"><span data-stu-id="4a8b5-325">InitComplete (New in 2.0)</span></span>
...
## <a name="prerendercomplete-new-in-20"></a><span data-ttu-id="4a8b5-337">PreRenderComplete (Nowość w wersji 2.0)</span><span class="sxs-lookup"><span data-stu-id="4a8b5-337">PreRenderComplete (New in 2.0)</span></span>
...
### <a name="circumventing-findcontrol"></a><span data-ttu-id="4a8b5-363">Obejście FindControl</span><span class="sxs-lookup"><span data-stu-id="4a8b5-363">Circumventing FindControl</span></span>
...
<span data-ttu-id="4a8b5-435">Nazwa funkcji po stronie klienta, która będzie akceptować wartości zwracanej (jako ciąg) ze zdarzenia wywołania zwrotnego po stronie serwera.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-435">The name of the client-side function that will accept the return value (as string) from the server-side callback event.</span></span> <span data-ttu-id="4a8b5-436">Ta funkcja będzie wywoływana tylko, po pomyślnym zakończeniu operacji wywołania zwrotnego po stronie serwera.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-436">This function will only be called when the server-side callback is successful.</span></span> <span data-ttu-id="4a8b5-437">W związku ze względu na niezawodność, ogólnie zaleca się korzystać z przeciążoną wersją GetCallbackEventReference, która przyjmuje argument dodatkowy ciąg określający nazwę funkcję po stronie klienta do wykonania w przypadku wystąpienia błędu.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-437">Therefore, for the sake of robustness, it is generally recommended to use the overloaded version of GetCallbackEventReference that takes an additional string argument specifying the name of a client-side function to execute in the event of an error.</span></span>

`null`

<span data-ttu-id="4a8b5-438">Ciąg reprezentujący funkcji po stronie klienta, który je zainicjował przed wywołania zwrotnego do serwera.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-438">A string representing a client-side function that it initiated before the callback to the server.</span></span> <span data-ttu-id="4a8b5-439">W tym przypadku nie jest bez skryptu, argument ma wartość null.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-439">In this case, there is no such script, so the argument is null.</span></span>

`true`

<span data-ttu-id="4a8b5-440">Wartość logiczna określająca, czy należy przeprowadzić asynchroniczne wywołanie zwrotne.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-440">A Boolean specifying whether or not to conduct the callback asynchronously.</span></span>

<span data-ttu-id="4a8b5-441">Wywołanie metody formularza sieci Web\_DoCallback na komputerze klienckim przekazują tych argumentów.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-441">The call to WebForm\_DoCallback on the client will pass these arguments.</span></span> <span data-ttu-id="4a8b5-442">W związku z tym, gdy ta strona jest wyświetlana na komputerze klienckim, ten kod będzie wyglądać w następujący sposób:</span><span class="sxs-lookup"><span data-stu-id="4a8b5-442">Therefore, when this page is rendered on the client, that code will look like so:</span></span>

[!code-javascript[Main](the-asp-net-2-0-page-model/samples/sample14.js)]

<span data-ttu-id="4a8b5-443">Należy zauważyć, że podpis funkcji na komputerze klienckim jest nieco inna.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-443">Notice that the signature of the function on the client is a bit different.</span></span> <span data-ttu-id="4a8b5-444">Funkcja klienta przekazuje 5 parametrów i wartość logiczną.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-444">The client-side function passes 5 strings and a Boolean.</span></span> <span data-ttu-id="4a8b5-445">Dodatkowe parametry, (który ma wartość null w powyższym przykładzie) zawiera funkcję po stronie klienta, która będzie obsługiwać ewentualne błędy z wywołania zwrotnego po stronie serwera.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-445">The additional string (which is null in the above example) contains the client-side function that will handle any errors from the server-side callback.</span></span>

## <a name="step-3--hook-the-client-side-control-event"></a><span data-ttu-id="4a8b5-446">Krok 3: Obsługiwać zdarzenia formantu po stronie klienta</span><span class="sxs-lookup"><span data-stu-id="4a8b5-446">Step 3 : Hook the Client-Side Control Event</span></span>

<span data-ttu-id="4a8b5-447">Należy zauważyć, że wartość zwracana przez GetCallbackEventReference powyżej został przypisany do zmiennej ciągu.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-447">Notice that the return value of GetCallbackEventReference above was assigned to a string variable.</span></span> <span data-ttu-id="4a8b5-448">Ten ciąg jest używany do podłączania zdarzeń po stronie klienta, dla formantu, który inicjuje wywołanie zwrotne.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-448">That string is used to hook a client-side event for the control that initiates the callback.</span></span> <span data-ttu-id="4a8b5-449">W tym przykładzie wywołanie zwrotne jest inicjowane przez listę rozwijaną na stronie tak, chcę dołączyć *OnChange* zdarzeń.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-449">In this example, the callback is initiated by a dropdown on the page, so I want to hook the *OnChange* event.</span></span>

<span data-ttu-id="4a8b5-450">Aby obsługiwać zdarzenia po stronie klienta, po prostu Dodaj program obsługi znaczników po stronie klienta w następujący sposób:</span><span class="sxs-lookup"><span data-stu-id="4a8b5-450">To hook the client-side event, simply add a handler to the client-side markup as follows:</span></span>

[!code-csharp[Main](the-asp-net-2-0-page-model/samples/sample15.cs)]

<span data-ttu-id="4a8b5-451">Pamiętamy *cbRef* jest wartością zwracaną z wywołania GetCallbackEventReference.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-451">Recall that *cbRef* is the return value from the call to GetCallbackEventReference.</span></span> <span data-ttu-id="4a8b5-452">Zawiera wywołanie metody formularza sieci Web\_DoCallback, który został wyświetlony powyżej.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-452">It contains the call to WebForm\_DoCallback that was shown above.</span></span>

## <a name="step-4--register-the-client-side-script"></a><span data-ttu-id="4a8b5-453">Krok 4: Zarejestruj skryptu po stronie klienta</span><span class="sxs-lookup"><span data-stu-id="4a8b5-453">Step 4 : Register the Client-Side Script</span></span>

<span data-ttu-id="4a8b5-454">Odwołania, które wywołanie GetCallbackEventReference określone, czy skrypt po stronie klienta o nazwie **ShowCompanyName** będzie wykonywany po pomyślnym zakończeniu wywołania zwrotnego po stronie serwera.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-454">Recall that the call to GetCallbackEventReference specified that a client-side script called **ShowCompanyName** would be executed when the server-side callback succeeds.</span></span> <span data-ttu-id="4a8b5-455">Czy skrypt musi zostać dodane do strony, przy użyciu wystąpienia ClientScriptManager.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-455">That script needs to be added to the page using a ClientScriptManager instance.</span></span> <span data-ttu-id="4a8b5-456">(W klasie ClientScriptManager będzie dicussed w dalszej części tego modułu). Dlatego należy wykonać podobne do tego:</span><span class="sxs-lookup"><span data-stu-id="4a8b5-456">(The ClientScriptManager class will be dicussed later in this module.) You do that like so:</span></span>

[!code-javascript[Main](the-asp-net-2-0-page-model/samples/sample16.js)]

## <a name="step-5--call-the-methods-of-the-icallbackeventhandler-interface"></a><span data-ttu-id="4a8b5-457">Krok 5: Wywołanie metody interfejsu ICallbackEventHandler</span><span class="sxs-lookup"><span data-stu-id="4a8b5-457">Step 5 : Call the Methods of the ICallbackEventHandler Interface</span></span>

<span data-ttu-id="4a8b5-458">ICallbackEventHandler zawiera dwie metody, które są potrzebne do zaimplementowania w kodzie.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-458">The ICallbackEventHandler contains two methods that you need to implement in your code.</span></span> <span data-ttu-id="4a8b5-459">Są one **RaiseCallbackEvent** i **GetCallbackEvent**.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-459">They are **RaiseCallbackEvent** and **GetCallbackEvent**.</span></span>

<span data-ttu-id="4a8b5-460">**RaiseCallbackEvent** przyjmuje ciąg jako argument i zwraca nothing.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-460">**RaiseCallbackEvent** takes a string as an argument and returns nothing.</span></span> <span data-ttu-id="4a8b5-461">Argument ciągu jest przekazywany z wywołania po stronie klienta, aby formularz sieci Web\_DoCallback.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-461">The string argument is passed from the client-side call to WebForm\_DoCallback.</span></span> <span data-ttu-id="4a8b5-462">W takim przypadku ta wartość jest *wartość* atrybutu z listy rozwijanej o nazwie ddlCompany.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-462">In this case, that value is the *value* attribute of the dropdown called ddlCompany.</span></span> <span data-ttu-id="4a8b5-463">Kod po stronie serwera, należy umieścić w metodzie RaiseCallbackEvent.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-463">Your server-side code should be placed in the RaiseCallbackEvent method.</span></span> <span data-ttu-id="4a8b5-464">Na przykład jeśli wywołanie zwrotne WebRequest względem zewnętrznego zasobu, ten kod będzie umieszczona w RaiseCallbackEvent.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-464">For example, if your callback is making a WebRequest against an external resource, that code should be placed in RaiseCallbackEvent.</span></span>

<span data-ttu-id="4a8b5-465">**GetCallbackEvent** jest odpowiedzialna za przetwarzanie zwracana wywołania zwrotnego do klienta.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-465">**GetCallbackEvent** is responsible for processing the return of the callback to the client.</span></span> <span data-ttu-id="4a8b5-466">Go nie przyjmuje żadnych argumentów i zwraca wartość typu ciąg.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-466">It takes no arguments and returns a string.</span></span> <span data-ttu-id="4a8b5-467">Ciąg, który zwraca zostaną przekazane jako argument do funkcji po stronie klienta, w tym przypadku *ShowCompanyName*.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-467">The string that it returns will be passed as an argument to the client-side function, in this case *ShowCompanyName*.</span></span>

<span data-ttu-id="4a8b5-468">Po wykonaniu powyższych czynności można przystąpić do wykonania skryptu wywołania zwrotnego w programie ASP.NET 2.0.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-468">Once you have completed the above steps, you are ready to perform a script callback in ASP.NET 2.0.</span></span>


![](the-asp-net-2-0-page-model/_static/image4.png)


[<span data-ttu-id="4a8b5-469">Otwórz wideo pełnego ekranu</span><span class="sxs-lookup"><span data-stu-id="4a8b5-469">Open Full-Screen Video</span></span>](the-asp-net-2-0-page-model/_static/callback1.wmv)


<span data-ttu-id="4a8b5-470">Wywołania zwrotne skryptu, na platformie ASP.NET są obsługiwane w dowolnej przeglądarki obsługującej wprowadzania wywołania XMLHttp.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-470">Script callbacks in ASP.NET are supported in any browser that supports making XMLHttp calls.</span></span> <span data-ttu-id="4a8b5-471">Obejmuje to wszystkie nowoczesne przeglądarki używana już dziś.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-471">That includes all of the modern browsers in use today.</span></span> <span data-ttu-id="4a8b5-472">Program Internet Explorer używa obiektu XMLHttp ActiveX, podczas gdy inne nowoczesnych przeglądarek (w tym nadchodzących programu Internet Explorer 7) używają wewnętrzne obiektu XMLHttp.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-472">Internet Explorer uses the XMLHttp ActiveX object while other modern browsers (including the upcoming IE 7) use an intrinsic XMLHttp object.</span></span> <span data-ttu-id="4a8b5-473">Aby programowo określić, jeśli przeglądarka obsługuje wywołania zwrotne, możesz użyć **Request.Browser.SupportCallback** właściwości.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-473">To programmatically determine if a browser supports callbacks, you can use the **Request.Browser.SupportCallback** property.</span></span> <span data-ttu-id="4a8b5-474">Właściwość ta zwróci **true** Jeśli żądanie klienta obsługuje wywołania zwrotne skryptu.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-474">This property will return **true** if the requesting client supports script callbacks.</span></span>

## <a name="working-with-client-script-in-aspnet-20"></a><span data-ttu-id="4a8b5-475">Praca ze skryptem klienta w programie ASP.NET 2.0</span><span class="sxs-lookup"><span data-stu-id="4a8b5-475">Working with Client Script in ASP.NET 2.0</span></span>

<span data-ttu-id="4a8b5-476">Skrypty klienta w programie ASP.NET 2.0 są zarządzane przez użycie klasy ClientScriptManager.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-476">Client scripts in ASP.NET 2.0 are managed via the use of the ClientScriptManager class.</span></span> <span data-ttu-id="4a8b5-477">Klasa ClientScriptManager przechowuje informacje o skryptów klienta przy użyciu typu i nazwy.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-477">The ClientScriptManager class keeps track of client scripts using a type and a name.</span></span> <span data-ttu-id="4a8b5-478">Zapobiega to programowo wstawiane na stronie więcej niż jeden raz przez tego samego skryptu.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-478">This prevents the same script from being programmatically inserted on a page more than once.</span></span>

> [!NOTE]
> <span data-ttu-id="4a8b5-479">Po skrypt został pomyślnie zarejestrowany na stronie, żadne kolejne próby, aby zarejestrować ten sam skrypt powoduje po prostu skrypt nie jest zarejestrowany po raz drugi.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-479">After a script has been successfully registered on a page, any subsequent attempt to register the same script will simply result in the script not being registered a second time.</span></span> <span data-ttu-id="4a8b5-480">Nie zduplikowane skryptów są dodawane, a nie wystąpi wyjątek.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-480">No duplicate scripts are added and no exception occurs.</span></span> <span data-ttu-id="4a8b5-481">Aby uniknąć niepotrzebnych obliczeń, istnieją metody, które można użyć w celu ustalenia, czy skrypt został już zarejestrowany, tak aby nie należy go zarejestrować więcej niż jeden raz.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-481">To avoid unnecessary computation, there are methods that you can use to determine if a script is already registered so that you do not attempt to register it more than once.</span></span>


<span data-ttu-id="4a8b5-482">Metody ClientScriptManager powinny być znane wszystkie bieżące deweloperów platformy ASP.NET:</span><span class="sxs-lookup"><span data-stu-id="4a8b5-482">The methods of the ClientScriptManager should be familiar to all current ASP.NET developers:</span></span>

## <a name="registerclientscriptblock"></a><span data-ttu-id="4a8b5-483">RegisterClientScriptBlock</span><span class="sxs-lookup"><span data-stu-id="4a8b5-483">RegisterClientScriptBlock</span></span>

<span data-ttu-id="4a8b5-484">Metoda ta umożliwia dodanie skryptu na początku renderowanej strony.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-484">This method adds a script to the top of the rendered page.</span></span> <span data-ttu-id="4a8b5-485">Jest to przydatne, aby dodać funkcje, które będą wywoływane jawnie na komputerze klienckim.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-485">This is useful for adding functions that will be explicitly called on the client.</span></span>

<span data-ttu-id="4a8b5-486">Istnieją dwie przeciążone wersje tej metody.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-486">There are two overloaded versions of this method.</span></span> <span data-ttu-id="4a8b5-487">Trzy z czterech argumentów występują między nimi.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-487">Three of four arguments are common among them.</span></span> <span data-ttu-id="4a8b5-488">Są to:</span><span class="sxs-lookup"><span data-stu-id="4a8b5-488">They are:</span></span>

`type (string)`

<span data-ttu-id="4a8b5-489">***Typu*** argument określa typ skryptu.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-489">The ***type*** argument identifies a type for the script.</span></span> <span data-ttu-id="4a8b5-490">Zazwyczaj jest to dobry pomysł, aby użyć typu strony, (to. GetType()) dla typu.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-490">It is generally a good idea to use the page's type (this.GetType()) for the type.</span></span>

`key (string)`

<span data-ttu-id="4a8b5-491">***Klucz*** argument jest zdefiniowane przez użytkownika klucza dla skryptu.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-491">The ***key*** argument is a user-defined key for the script.</span></span> <span data-ttu-id="4a8b5-492">Powinna to być unikatowy dla każdego skryptu.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-492">This should be unique for each script.</span></span> <span data-ttu-id="4a8b5-493">Jeśli spróbujesz dodać skrypt za pomocą tego samego klucza i typ skryptu dodane wcześniej, nie można dodać.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-493">If you attempt to add a script with the same key and type of an already added script, it will not be added.</span></span>

`script (string)`

<span data-ttu-id="4a8b5-494">***Skryptu*** argument jest ciąg zawierający rzeczywiste skryptu, aby dodać.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-494">The ***script*** argument is a string containing the actual script to add.</span></span> <span data-ttu-id="4a8b5-495">Zalecane jest, użyj klasy StringBuilder można utworzyć skrypt, a następnie zastosować metodę ToString() StringBuilder można przypisać ***skryptu*** argumentu.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-495">It's recommended that you use a StringBuilder to create the script and then use the ToString() method on the StringBuilder to assign the ***script*** argument.</span></span>

<span data-ttu-id="4a8b5-496">Jeśli używasz RegisterClientScriptBlock przeciążona, który tylko przyjmuje trzy argumenty, musi zawierać elementy skryptu (&lt;skryptu&gt; i &lt;/script&gt;) w skrypcie.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-496">If you use the overloaded RegisterClientScriptBlock that only takes three arguments, you must include script elements (&lt;script&gt; and &lt;/script&gt;) in your script.</span></span>

<span data-ttu-id="4a8b5-497">Można użyć przeciążenia RegisterClientScriptBlock, która przyjmuje czwarty argument.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-497">You may choose to use the overload of RegisterClientScriptBlock that takes a fourth argument.</span></span> <span data-ttu-id="4a8b5-498">Czwarty argument jest wartość logiczna określająca, czy ASP.NET, należy dodać elementy skryptu dla Ciebie.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-498">The fourth argument is a Boolean that specifies whether or not ASP.NET should add script elements for you.</span></span> <span data-ttu-id="4a8b5-499">Jeśli ten argument jest **true**, skrypt nie może zawierać elementy skryptu jawnie.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-499">If this argument is **true**, your script should not include the script elements explicitly.</span></span>

<span data-ttu-id="4a8b5-500">Należy użyć metody IsClientScriptBlockRegistered, aby określić, jeśli skrypt został już zarejestrowany.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-500">Use the IsClientScriptBlockRegistered method to determine if a script has already been registered.</span></span> <span data-ttu-id="4a8b5-501">Dzięki temu można uniknąć próba ponownego zarejestrowania skrypt, który został już zarejestrowany.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-501">This allows you to avoid an attempt to re-register a script that has already been registered.</span></span>

### <a name="registerclientscriptinclude-new-in-20"></a><span data-ttu-id="4a8b5-502">RegisterClientScriptInclude (Nowość w wersji 2.0)</span><span class="sxs-lookup"><span data-stu-id="4a8b5-502">RegisterClientScriptInclude (New in 2.0)</span></span>

<span data-ttu-id="4a8b5-503">RegisterClientScriptInclude tag tworzy blok skryptu, który stanowi łącze do zewnętrznego pliku skryptu.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-503">The RegisterClientScriptInclude tag creates a script block that links to an external script file.</span></span> <span data-ttu-id="4a8b5-504">Ma dwa przeciążenia.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-504">It has two overloads.</span></span> <span data-ttu-id="4a8b5-505">Przyjmuje jeden klucz i adres URL.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-505">One takes a key and a URL.</span></span> <span data-ttu-id="4a8b5-506">Drugi dodaje trzeci argument określenie typu.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-506">The second adds a third argument specifying the type.</span></span>

<span data-ttu-id="4a8b5-507">Na przykład, poniższy kod generuje blok skryptu zawierającego łącze do jsfunctions.js w katalogu głównym folderu skryptów aplikacji:</span><span class="sxs-lookup"><span data-stu-id="4a8b5-507">For example, the following code generates a script block that links to jsfunctions.js in the root of the scripts folder of the application:</span></span>

[!code-csharp[Main](the-asp-net-2-0-page-model/samples/sample17.cs)]

<span data-ttu-id="4a8b5-508">Ten kod tworzy następujący kod na renderowanej stronie:</span><span class="sxs-lookup"><span data-stu-id="4a8b5-508">This code produces the following code in the rendered page:</span></span>

[!code-html[Main](the-asp-net-2-0-page-model/samples/sample18.html)]

> [!NOTE]
> <span data-ttu-id="4a8b5-509">Blok skryptu jest renderowany w dolnej części strony.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-509">The script block is rendered at the bottom of the page.</span></span>


<span data-ttu-id="4a8b5-510">Należy użyć metody IsClientScriptIncludeRegistered, aby określić, jeśli skrypt został już zarejestrowany.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-510">Use the IsClientScriptIncludeRegistered method to determine if a script has already been registered.</span></span> <span data-ttu-id="4a8b5-511">Dzięki temu można uniknąć próba ponownego zarejestrowania skrypt.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-511">This allows you to avoid an attempt to re-register a script.</span></span>

## <a name="registerstartupscript"></a><span data-ttu-id="4a8b5-512">RegisterStartupScript</span><span class="sxs-lookup"><span data-stu-id="4a8b5-512">RegisterStartupScript</span></span>

<span data-ttu-id="4a8b5-513">Metoda RegisterStartupScript przyjmuje te same argumenty co metoda RegisterClientScriptBlock.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-513">The RegisterStartupScript method takes the same arguments as the RegisterClientScriptBlock method.</span></span> <span data-ttu-id="4a8b5-514">Zarejestrowane w usłudze RegisterStartupScript skrypt wykonuje po załadowaniu strony, ale przed zdarzeniem OnLoad po stronie klienta.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-514">A script registered with RegisterStartupScript executes after the page loads but before the OnLoad client-side event.</span></span> <span data-ttu-id="4a8b5-515">W 1.X, zarejestrowane w usłudze RegisterStartupScript skrypty zostały umieszczone bezpośrednio przed zamykającym &lt;/form&gt; tagów podczas zarejestrowane w usłudze RegisterClientScriptBlock skrypty zostały umieszczone bezpośrednio po otwarciu &lt;formularza&gt; tagu.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-515">In 1.X, scripts registered with RegisterStartupScript were placed just before the closing &lt;/form&gt; tag while scripts registered with RegisterClientScriptBlock were placed immediately after the opening &lt;form&gt; tag.</span></span> <span data-ttu-id="4a8b5-516">W programie ASP.NET 2.0, oba są umieszczane bezpośrednio przed tagiem zamykającym &lt;/form&gt; tagu.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-516">In ASP.NET 2.0, both are placed immediately before the closing &lt;/form&gt; tag.</span></span>

> [!NOTE]
> <span data-ttu-id="4a8b5-517">Jeśli zarejestrowane przez funkcję RegisterStartupScript, tej funkcji nie będą wykonywane, dopóki nie zostanie jawnie wywołana w kodzie po stronie klienta.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-517">If you register a function with RegisterStartupScript, that function will not execute until you explicitly call it in client-side code.</span></span>


<span data-ttu-id="4a8b5-518">Aby określić, jeśli skrypt został już zarejestrowany i uniknąć próba ponownego zarejestrowania skrypt, należy użyć metody IsStartupScriptRegistered.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-518">Use the IsStartupScriptRegistered method to determine if a script has already been registered and avoid an attempt to re-register a script.</span></span>

## <a name="other-clientscriptmanager-methods"></a><span data-ttu-id="4a8b5-519">Inne metody ClientScriptManager</span><span class="sxs-lookup"><span data-stu-id="4a8b5-519">Other ClientScriptManager Methods</span></span>

<span data-ttu-id="4a8b5-520">Poniżej przedstawiono niektóre inne użyteczne metody klasy ClientScriptManager.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-520">Here are some of the other useful methods of the ClientScriptManager class.</span></span>


|  <span data-ttu-id="4a8b5-521"><strong>GetCallbackEventReference</strong></span><span class="sxs-lookup"><span data-stu-id="4a8b5-521"><strong>GetCallbackEventReference</strong></span></span>   |                                                 <span data-ttu-id="4a8b5-522">Zobacz wywołania zwrotne skryptu, we wcześniejszej części tego modułu.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-522">See script callbacks earlier in this module.</span></span>                                                 |
|-----------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------|
|  <span data-ttu-id="4a8b5-523"><strong>GetPostBackClientHyperlink</strong></span><span class="sxs-lookup"><span data-stu-id="4a8b5-523"><strong>GetPostBackClientHyperlink</strong></span></span>  |                <span data-ttu-id="4a8b5-524">Pobiera odniesienie JavaScript (javascript:&lt;wywołania&gt;) który może służyć do opublikowania powrót po awarii z zdarzenia po stronie klienta.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-524">Gets a JavaScript reference (javascript:&lt;call&gt;) that can be used to post back from a client-side event.</span></span>                 |
|  <span data-ttu-id="4a8b5-525"><strong>GetPostBackEventReference</strong></span><span class="sxs-lookup"><span data-stu-id="4a8b5-525"><strong>GetPostBackEventReference</strong></span></span>   |                                   <span data-ttu-id="4a8b5-526">Pobiera ciąg, który może służyć do inicjowania wpis przez klienta.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-526">Gets a string that can be used to initiate a post back from the client.</span></span>                                    |
|      <span data-ttu-id="4a8b5-527"><strong>GetWebResourceUrl</strong></span><span class="sxs-lookup"><span data-stu-id="4a8b5-527"><strong>GetWebResourceUrl</strong></span></span>       | <span data-ttu-id="4a8b5-528">Zwraca adres URL do zasobu, który jest osadzony w zestawie.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-528">Returns a URL to a resource that is embedded in an assembly.</span></span> <span data-ttu-id="4a8b5-529">Należy używać w połączeniu z <strong>RegisterClientScriptResource</strong>.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-529">Must be used in conjunction with <strong>RegisterClientScriptResource</strong>.</span></span> |
| <span data-ttu-id="4a8b5-530"><strong>RegisterClientScriptResource</strong></span><span class="sxs-lookup"><span data-stu-id="4a8b5-530"><strong>RegisterClientScriptResource</strong></span></span> |     <span data-ttu-id="4a8b5-531">Rejestruje zasobu sieci Web ze stroną.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-531">Registers a Web resource with the page.</span></span> <span data-ttu-id="4a8b5-532">Są to zasoby osadzone w zestawie i obsługiwane przez nowy program obsługi WebResource.axd.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-532">These are resources embedded in an assembly and handled by the new WebResource.axd handler.</span></span>      |
|     <span data-ttu-id="4a8b5-533"><strong>RegisterHiddenField</strong></span><span class="sxs-lookup"><span data-stu-id="4a8b5-533"><strong>RegisterHiddenField</strong></span></span>      |                                                 <span data-ttu-id="4a8b5-534">Rejestruje ukryte pole formularza ze stroną.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-534">Registers a hidden form field with the page.</span></span>                                                 |
|  <span data-ttu-id="4a8b5-535"><strong>RegisterOnSubmitStatement</strong></span><span class="sxs-lookup"><span data-stu-id="4a8b5-535"><strong>RegisterOnSubmitStatement</strong></span></span>   |                                  <span data-ttu-id="4a8b5-536">Rejestruje kod po stronie klienta, który jest wykonywany po przesłaniu formularza HTML.</span><span class="sxs-lookup"><span data-stu-id="4a8b5-536">Registers client-side code that executes when the HTML form is submitted.</span></span>                                   |
