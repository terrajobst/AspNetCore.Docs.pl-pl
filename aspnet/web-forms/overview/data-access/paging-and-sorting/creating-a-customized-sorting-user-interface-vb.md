...
ms.locfileid: "30892676"
---
<a name="creating-a-customized-sorting-user-interface-vb"></a>Tworzenie interfejsu użytkownika sortowania dostosowanych (VB)
====================
przez [Bento Scott](https://twitter.com/ScottOnWriting)

[Pobierz przykładową aplikację](http://download.microsoft.com/download/9/c/1/9c1d03ee-29ba-4d58-aa1a-f201dcc822ea/ASPNET_Data_Tutorial_27_VB.exe) lub [pobierania plików PDF](creating-a-customized-sorting-user-interface-vb/_static/datatutorial27vb1.pdf)
...
[![Każda grupa kategorii jest jasno określone](creating-a-customized-sorting-user-interface-vb/_static/image2.png)](creating-a-customized-sorting-user-interface-vb/_static/image1.png)

**Rysunek 1**: każdy grupy kategorii jest zidentyfikowane ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](creating-a-customized-sorting-user-interface-vb/_static/image3.png))
...
[![S GridView można sortować według kategorii porządkowania danych](creating-a-customized-sorting-user-interface-vb/_static/image5.png)](creating-a-customized-sorting-user-interface-vb/_static/image4.png)

**Rysunek 2**: s sortowania w widoku GridView danych porządkowania według kategorii ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](creating-a-customized-sorting-user-interface-vb/_static/image6.png))
...
[![Technikę alternatywny manipuluje hierarchii kontroli s widoku GridView](creating-a-customized-sorting-user-interface-vb/_static/image9.png)](creating-a-customized-sorting-user-interface-vb/_static/image8.png)

**Rysunek 4**: technikę alternatywny manipuluje s GridView hierarchii formantu ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](creating-a-customized-sorting-user-interface-vb/_static/image10.png))
...
**Rysunek 5**: sortowanie interfejsu obejmuje sortowania grupy nagłówków podczas sortowania według BoundFields ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](creating-a-customized-sorting-user-interface-vb/_static/image13.png))
...
**Rysunek 6**: sortowanie grupy nagłówki są Brak podczas sortowania CheckBoxField ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](creating-a-customized-sorting-user-interface-vb/_static/image16.png))
...
**Rysunek 7**: sortowanie grupy nagłówki są teraz obecny podczas sortowania CheckBoxField ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](creating-a-customized-sorting-user-interface-vb/_static/image19.png))
