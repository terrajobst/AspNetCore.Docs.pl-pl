...
**Rysunek 1**: każdej grupy kategorii są jasno określone ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](creating-a-customized-sorting-user-interface-vb/_static/image3.png))


W tym samouczku opisano sposób tworzenia takiego sortowania interfejs użytkownika.

## <a name="step-1-creating-a-standard-sortable-gridview"></a>Krok 1: Tworzenie standardowych, sortowanie kontrolki GridView
...
## <a name="step-2-exploring-techniques-for-adding-the-separator-rows"></a>Krok 2: Eksplorowania technik Dodawanie wierszy separatora
...
**Rysunek 6**: nagłówków grup sortowania są Brak podczas sortowania CheckBoxField ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](creating-a-customized-sorting-user-interface-vb/_static/image16.png))
...
**Rysunek 7**: nagłówków grup sortowania są teraz obecny podczas sortowania CheckBoxField ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](creating-a-customized-sorting-user-interface-vb/_static/image19.png))
