...
**Rysunek 1**: należą każdej kategorii, wraz z jej produktów ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](nested-data-web-controls-vb/_static/image3.png))
...
**Rysunek 4**: s każdej kategorii, nazwa i opis ma na liście, oddzielone linii poziomej ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](nested-data-web-controls-vb/_static/image12.png))
...
**Rysunek 5**: Repeater Wyświetla każdej kategorii zewnętrznej; Wyświetla jeden wewnętrzny produktów dla tej kategorii ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](nested-data-web-controls-vb/_static/image15.png))
