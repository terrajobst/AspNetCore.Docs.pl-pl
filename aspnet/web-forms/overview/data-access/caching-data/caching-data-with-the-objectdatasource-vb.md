...
**Rysunek 6**: Włącz GridView obsługę edycji, sortowania i stronicowania ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](caching-data-with-the-objectdatasource-vb/_static/image14.png))
...
**Rysunek 7**: s każdego produktu, nazwa, kategoria i cena znajduje się w sortowanie, Pageable, można edytować kontrolki GridView ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](caching-data-with-the-objectdatasource-vb/_static/image17.png))
...
**Rysunek 9**: zawsze, gdy widok GridView jest odbitych ze swoim źródłem danych, wybranie event uruchamiany jest wyświetlany ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](caching-data-with-the-objectdatasource-vb/_static/image23.png))
