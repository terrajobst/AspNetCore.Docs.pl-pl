...
## <a name="step-2-updating-the-business-logic-layer"></a>Krok 2: Trwa aktualizowanie warstwy logiki biznesowej
...
## <a name="step-3-listing-the-existing-categories-and-their-binary-data"></a>Krok 3: Wyświetlanie istniejących kategorii i ich dane binarne
...
**Rysunek 4**: możesz powinny teraz Zobacz każdej kategorii wraz z jego danymi binarnymi ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image8.png))
...
**Rysunek 6**: powiązywanie DetailsView do `CategoriesDataSource` i umożliwić wstawianie ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image12.png))
...
**Rysunek 7**: powiązywanie DetailsView do `CategoriesDataSource` i umożliwić wstawianie
...
**Rysunek 8**: Dodawanie formantu z przekazywaniem plików `InsertItemTemplate` ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image14.png))
...
## <a name="step-7-saving-the-uploaded-picture-to-the-database"></a>Krok 7: Zapisywania przekazanego obrazu z bazą danych
...
## <a name="step-8-fixing-thedisplaycategorypictureaspxpage"></a>Krok 8: Rozwiązywanie`DisplayCategoryPicture.aspx`strony
