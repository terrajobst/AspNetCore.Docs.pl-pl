...
title: W tym pliku Przekaż opcja podczas dodawania nowego rekordu (VB) | Dokumentacja firmy Microsoft
...
---
<a name="including-a-file-upload-option-when-adding-a-new-record-vb"></a>Podczas dodawania nowego rekordu (VB) w tym opcja przekazywania pliku
====================
przez [Bento Scott](https://twitter.com/ScottOnWriting)

[Pobierz przykładową aplikację](http://download.microsoft.com/download/4/a/7/4a7a3b18-d80e-4014-8e53-a6a2427f0d93/ASPNET_Data_Tutorial_56_VB.exe) lub [pobierania plików PDF](including-a-file-upload-option-when-adding-a-new-record-vb/_static/datatutorial56vb1.pdf)
...
Gdy utworzyliśmy `CategoriesTableAdapter` w [tworzenie Warstwa dostępu do danych](../introduction/creating-a-data-access-layer-vb.md) samouczka został skonfigurowany do automatycznego generowania `INSERT`, `UPDATE`, i `DELETE` instrukcje na podstawie głównego zapytania. Ponadto możemy instrukcją TableAdapter fragmentów DB bezpośredniego podejście, które tworzone metody `Insert`, `Update`, i `Delete`. Wykonanie tych metod generowanych automatycznie `INSERT`, `UPDATE`, i `DELETE` instrukcje i w związku z tym, Zaakceptuj parametrów wejściowych, na podstawie kolumn zwrócony przez główne zapytanie. W [przesyłanie plików](uploading-files-vb.md) samouczku będziemy rozszerzony `CategoriesTableAdapter` s główne zapytanie do używania `BrochurePath` kolumny.
...
[![Wybierz opcję WSTAWIANIA](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image1.gif)](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image1.png)
...
[![Nazwa nowej InsertWithPicture metody TableAdapter](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image2.gif)](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image3.png)
...
[![Skopiuj i Wklej składni deklaratywnej z DisplayOrDownload.aspx UploadInDetailsView.aspx](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image3.gif)](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image5.png)

**Rysunek 3**: kopiowanie i wklejanie składni deklaratywnej z `DisplayOrDownload.aspx` do `UploadInDetailsView.aspx` ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image6.png))
...
[![Powinien zostać wyświetlony każdej kategorii, wraz z jego dane binarne](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image4.gif)](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image7.png)

**Rysunek 4**: możesz powinny teraz Zobacz każdy kategorii wraz z jego danych binarnych ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image8.png))
...
[![Skonfiguruj element ObjectDataSource przy użyciu metody InsertWithPicture](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image5.gif)](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image9.png)

**Rysunek 5**: Konfigurowanie ObjectDataSource do użycia `InsertWithPicture` — metoda ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image10.png))
...
[![Powiązać widoku DetailsView CategoriesDataSource i Włącz wstawianie](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image6.gif)](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image11.png)

**Rysunek 6**: Bind do widoku DetailsView `CategoriesDataSource` i Włącz wstawianie ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image12.png))
...
![Powiązać widoku DetailsView CategoriesDataSource i Włącz wstawianie](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image7.gif)
...
[![Dodawanie formantu przekazywaniem plików do InsertItemTemplate](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image8.gif)](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image13.png)

**Rysunek 8**: Dodawanie formantu przekazywaniem plików do `InsertItemTemplate` ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image14.png))
...
[![Ostrzeżenie jest wyświetlane, jeśli przekazano nieprawidłowy typ pliku](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image9.gif)](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image15.png)

**Rysunek 9**: ostrzeżenie komunikat jest wyświetlany, jeśli przekazano nieprawidłowy typ pliku ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image16.png))
...
[![Nową kategorię s obraz nie będzie wyświetlany.](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image10.gif)](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image17.png)

**Na rysunku nr 10**: s nową kategorię obraz nie jest wyświetlany ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image18.png))
...
[![Obrazów JPG dla nowej kategorii są renderowane poprawnie](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image11.gif)](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image19.png)

**Rysunek 11**: obrazów JPG dla nowej kategorii są renderowane poprawnie ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](including-a-file-upload-option-when-adding-a-new-record-vb/_static/image20.png))
