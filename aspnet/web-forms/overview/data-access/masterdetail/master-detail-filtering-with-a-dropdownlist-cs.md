...
**Rysunek 13**: są wyświetlane na początkowej stronie obciążenia bez produktów ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](master-detail-filtering-with-a-dropdownlist-cs/_static/image37.png))
