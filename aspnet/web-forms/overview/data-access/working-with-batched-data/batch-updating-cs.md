...
ms.locfileid: "37842195"
---
<a name="batch-updating-c"></a>Batch aktualizowanie (C#)
====================
...
**Rysunek 5**: Konwertowanie istniejącej BoundFields i CheckBoxField na TemplateField
...
**Rysunek 11**: powiązywanie kontrolki DropDownList do `CategoriesDataSource` ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](batch-updating-cs/_static/image20.png))
