...
**Rysunek 1**: można zmodyfikować każdy element w pełni edytowalne DataList ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](performing-batch-updates-cs/_static/image3.png))
...
**Rysunek 3**: pobieranie dostawcy informacje przy użyciu `GetSuppliers()` — metoda ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](performing-batch-updates-cs/_static/image9.png))
