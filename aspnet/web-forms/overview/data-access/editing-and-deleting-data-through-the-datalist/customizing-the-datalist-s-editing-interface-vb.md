...
**Rysunek 3**: nazwę, dostawca, kategoria, przerywane, stan i cena każdego produktu zostaną wyświetlone ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](customizing-the-datalist-s-editing-interface-vb/_static/image9.png))
...
**Rysunek 7**: interfejsu edycji kontrolki jest określone w poziomie, takich jak interfejs tylko do odczytu ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](customizing-the-datalist-s-editing-interface-vb/_static/image21.png))
...
**Rysunek 8**: kliknięcie przycisku Edytuj wyświetla interfejsu edycji ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](customizing-the-datalist-s-editing-interface-vb/_static/image24.png))
...
**Rysunek 9**: kliknięcie przycisku Edytuj wyświetla interfejsu edycji ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](customizing-the-datalist-s-editing-interface-vb/_static/image27.png))
