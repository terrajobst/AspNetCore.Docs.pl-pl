...
**Rysunek 15**: Previous i ostatniego przyciski są wyłączone podczas wyświetlania strony pierwszy produktów ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image43.png))
...
**Rysunek 18**: ostatniej strony danych, posortowane według kategorii, jest wyświetlany ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image52.png))
