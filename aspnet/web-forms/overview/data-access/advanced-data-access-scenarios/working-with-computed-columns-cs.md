...
**Rysunek 5**: zmiana nazwy `GetData` metody `GetSuppliers` ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](working-with-computed-columns-cs/_static/image15.png))
