...
ms.locfileid: "37837840"
---
<a name="configuring-the-data-access-layers-connection--and-command-level-settings-c"></a>Konfigurowanie ustawień poziomie połączenia i poleceń warstwy dostępu do danych (C#)
====================
