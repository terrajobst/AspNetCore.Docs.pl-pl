...
**Rysunek 3**: są wyświetlane tylko te produkty mniejszą niż lub równe 25,00 ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](using-parameterized-queries-with-the-sqldatasource-vb/_static/image6.png))
...
**Rysunek 4**: zwracać tylko te produkty mniejszą niż lub równa wartości parametru ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](using-parameterized-queries-with-the-sqldatasource-vb/_static/image8.png))
...
**Rysunek 6**: rekordy nie są wyświetlane, gdy `MaxPrice` pole tekstowe jest puste ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](using-parameterized-queries-with-the-sqldatasource-vb/_static/image12.png))
...
**Rysunek 12**: wyświetlane są wszystkie Beverages ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](using-parameterized-queries-with-the-sqldatasource-vb/_static/image24.png))


## <a name="step-4-programmatically-invoking-a-sqldatasource-sselectstatement"></a>Krok 4: Wywoływanie programowo SqlDataSource s`Select()`— instrukcja
...
**Rysunek 14**: nie określono źródła parametru lub wartości domyślnej ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](using-parameterized-queries-with-the-sqldatasource-vb/_static/image28.png))
...
**Rysunek 15**: nie określono źródła parametru lub wartości domyślnej ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](using-parameterized-queries-with-the-sqldatasource-vb/_static/image30.png))
