...
**Rysunek 4**: Twojej aplikacji powinny teraz zawierać dwa `Web.config` plików ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](user-based-authorization-vb/_static/image12.png))
...
**Rysunek 5**: ponieważ Autoryzacja adresów URL reguły Zabroń dostępu anonimowego, firma Microsoft nastąpi przekierowanie do strony logowania ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](user-based-authorization-vb/_static/image15.png))
...
## <a name="step-2-fixing-the-workflow-for-unauthorized-authenticated-users"></a>Krok 2: Ustalenie przepływu pracy dla nieautoryzowanych, uwierzytelnionych użytkowników
...
**Rysunek 8**: wybrany plik zawartość jest wyświetlana w polu tekstowym ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](user-based-authorization-vb/_static/image24.png))
