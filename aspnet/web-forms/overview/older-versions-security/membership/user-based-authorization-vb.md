...
> [!NOTE]
> `DirectoryInfo` i `FileInfo` klasy znajdują się w [ `System.IO` przestrzeni nazw](https://msdn.microsoft.com/en-us/library/system.io.aspx). W związku z tym będzie albo należy poprzedzić nazwy klas z ich nazwy przestrzeni nazw lub przestrzeń nazw, zaimportować do pliku klasy (za pośrednictwem `Imports System.IO`).
