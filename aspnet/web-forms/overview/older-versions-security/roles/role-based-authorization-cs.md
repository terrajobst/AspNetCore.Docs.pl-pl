...
**Rysunek 1**: zdarzenia potoku platformy ASP.NET dla uwierzytelniony użytkownik podczas za pomocą uwierzytelniania formularzy i struktury role ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](role-based-authorization-cs/_static/image3.png))
...
**Rysunek 4**: tylko użytkownicy należący do roli Administratorzy mogą wyświetlać strony chronione ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](role-based-authorization-cs/_static/image12.png))
...
**Rysunek 5**: Tito mogą odwiedzić `UsersAndRoles.aspx` strony ponieważ jest on w roli administratora ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](role-based-authorization-cs/_static/image15.png))
...
**Rysunek 14**: podczas edycji przycisk jest dostępny do opiekunów, przycisk Usuń jest ukryty ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](role-based-authorization-cs/_static/image42.png))
