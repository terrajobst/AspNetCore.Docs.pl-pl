...
**Rysunek 4**: użytkownika jest wysyłana wiadomość E-mail z jego nowe hasło ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](recovering-and-changing-passwords-cs/_static/image12.png))
...
**Rysunek 6**: Dodawanie formantu ChangePassword do strony ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](recovering-and-changing-passwords-cs/_static/image18.png))
...
**Rysunek 7**: Dodawanie formantu ChangePassword do strony ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](recovering-and-changing-passwords-cs/_static/image21.png))
...
**Rysunek 8**: wiadomości E-mail wyświetlony komunikat z informacją, ich hasło użytkownika został zmieniony ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](recovering-and-changing-passwords-cs/_static/image24.png))
