...
ms.locfileid: "41752079"
---
<a name="building-an-interface-to-select-one-user-account-from-many-vb"></a>Tworzenie interfejsu do wybierania jednego konta użytkownika spośród wielu (VB)
====================
...
**Rysunek 2**: mapy witryny zawiera węzeł o nazwie użytkownika administracji ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](building-an-interface-to-select-one-user-account-from-many-vb/_static/image6.png))
...
## <a name="step-3-filtering-the-results-by-the-first-letter-of-the-username"></a>Krok 3: Filtrowanie wyników za pierwsze litery nazwy użytkownika
...
**Rysunek 5**: Repeater Wyświetla 27 filtrowanie LinkButtons ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](building-an-interface-to-select-one-user-account-from-many-vb/_static/image15.png))
...
**Rysunek 6**: umożliwia filtrowanie LinkButtons wyświetlania tych użytkowników Whose Username rozpoczyna się od litery niektóre ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](building-an-interface-to-select-one-user-account-from-many-vb/_static/image18.png))


## <a name="step-4-updating-the-gridview-to-use-paging"></a>Krok 4: Aktualizowanie GridView używać stronicowania
...
**Rysunek 7**: Dodaj pierwszy, Wstecz Dalej i ostatniego LinkButtons poniżej kontrolki GridView ([kliknij, aby wyświetlić obraz w pełnym rozmiarze](building-an-interface-to-select-one-user-account-from-many-vb/_static/image21.png))
