...
- Aby włączyć łącze przeglądarki, ustaw `debug=true` w [ &lt;kompilacji&gt; ](https://msdn.microsoft.com/en-us/library/s10awwz0(v=vs.85).aspx) elementu w pliku Web.config dla projektu.
