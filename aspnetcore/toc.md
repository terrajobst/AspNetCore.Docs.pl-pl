...
### [Dodawanie weryfikacji](xref:tutorials/razor-pages/validation)
...
### [Dodawanie weryfikacji](tutorials/first-mvc-app/validation.md)
...
### [Sortowanie, filtrowanie, stronicowanie i grupowanie](xref:data/ef-rp/sort-filter-page)
...
### [Tworzenie usługi zaplecza dla natywnych aplikacji mobilnych](mobile/native-mobile-backend.md)
...
## [Wybieranie między środowiskiem uruchomieniowym .NET Core i .NET Framework](/dotnet/articles/standard/choosing-core-framework-server)
...
## [Struktura Knockout.js MVVM](xref:client-side/knockout)
## [Używanie AngularJS dla aplikacji jednostronicowych](xref:client-side/angular)
## [Używanie JavaScriptServices dla aplikacji jednostronicowych](xref:client-side/spa-services)
...
## [Kompilowanie projektów za pomocą narzędzia Yeoman](xref:client-side/yeoman)
...
### [Szablon projektu platformy Angular](xref:spa/angular)
### [Szablon projektu platformy React](xref:spa/react)
### [Szablon projektu platformy React z implementacją Redux](xref:spa/react-with-redux)
...
# [Hosting i wdrażanie](xref:publishing/index)
## [Hosting](xref:publishing/index)
### [Hosting w systemie Windows z usługami IIS](xref:publishing/iis)
#### [Odwołania do konfiguracji modułu platformy ASP.NET Core](xref:hosting/aspnet-core-module)
#### [Obsługa usług IIS w czasie opracowywania w programie Visual Studio dla platformy ASP.NET Core](xref:publishing/development-time-iis-support)
#### [Moduły usług IIS z platformą ASP.NET Core](xref:hosting/iis-modules)
### [Hosting w usłudze systemu Windows](xref:hosting/windows-service)
### [Hosting w systemie Linux z Nginx](xref:publishing/linuxproduction)
### [Hosting w systemie Linux z Apache](xref:publishing/apache-proxy)
### [Hosting na platformie Docker](xref:publishing/docker)
#### [Kompilowanie obrazów platformy Docker](https://docs.microsoft.com/dotnet/articles/core/docker/building-net-docker-images)
...
### [Ciągłe wdrażanie na platformie Azure za pomocą programu Visual Studio i rozwiązania Git](xref:publishing/azure-continuous-deployment)
...
### [Publikowanie profilów w programie Visual Studio](xref:publishing/web-publishing-vs)
...
### [Niestandardowi dostawcy magazynu dla produktu ASP.NET Identity](xref:security/authentication/identity-custom-storage-providers)
...
### [Włączanie generowania kodu QR w produkcie ASP.NET Identity](xref:security/authentication/identity-enable-qrcodes)
### [Uwierzytelnianie dwuskładnikowe za pomocą wiadomości SMS](xref:security/authentication/2fa)
### [Korzystanie z uwierzytelniania za pomocą plików cookie bez użycia produktu ASP.NET Core Identity](xref:security/authentication/cookie)
