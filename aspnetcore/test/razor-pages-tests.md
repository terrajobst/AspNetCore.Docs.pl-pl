...
[Wyświetlić lub pobrać przykładowy kod](https://github.com/aspnet/Docs/tree/master/aspnetcore/tests/razor-pages-tests/samples/) ([sposobu pobierania](xref:tutorials/index#how-to-download-a-sample))
