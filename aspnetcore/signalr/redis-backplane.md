...
* W aplikacji SignalR, należy zainstalować `Microsoft.AspNetCore.SignalR.Redis` pakietu NuGet.
...
* W aplikacji SignalR, należy zainstalować `Microsoft.AspNetCore.SignalR.StackExchangeRedis` pakietu NuGet.
