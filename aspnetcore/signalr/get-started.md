...
4. Utwórz nowy folder o nazwie "signalr" wewnątrz *lib* folder w projekcie. Następnie skopiuj *signalr.js* plik z *node_modules\\ @aspnet\signalr\dist\browser*  do tego folderu.
