...
> [!NOTE]
> Zasobów osadzonych nie uwidacznia katalogów. Zamiast ścieżki do zasobu (za pośrednictwem jego przestrzeni nazw) jest osadzony w jego przy użyciu nazwy pliku `.` separatorów.
