...
> [!NOTE]
> Użyj `skipRemainingRules: true` zawsze, gdy to możliwe ponieważ reguł dopasowania jest obliczeniowo kosztowne i skraca czas odpowiedzi aplikacji. Najszybszy odpowiedzi aplikacji:
>
