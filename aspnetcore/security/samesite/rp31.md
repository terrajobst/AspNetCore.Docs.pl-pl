...
---
# <a name="aspnet-core-31-razor-pages-samesite-cookie-sample"></a>Przykład ASP.NET Core SameSite 3,1 Razor Pages pliku cookie
...
W kodzie pokazanym powyżej zarówno uwierzytelnianie plików cookie, jak i stan sesji Ustaw ich atrybut sameSite na None, emitując atrybut z wartością `None`, a także ustaw atrybut Secure na true.
