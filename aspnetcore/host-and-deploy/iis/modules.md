...
| **Rejestrowanie HTTP**<br>`HttpLoggingModule`                                                          | Yes | [Rejestrowanie platformy ASP.NET Core](xref:fundamentals/logging/index) |
...
| **Obsługa protokołów**<br>`ProtocolSupportModule`                                                  | Yes | |
