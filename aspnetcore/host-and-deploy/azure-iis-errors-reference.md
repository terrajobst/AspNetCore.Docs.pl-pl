...
Następujące nie znajduje się pełna lista błędów. Powinien wystąpić błąd, który nie ma na liście w tym miejscu, pozostaw szczegółowy komunikat o błędzie w poniższej sekcji komentarzy.
