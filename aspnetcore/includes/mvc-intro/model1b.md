<span data-ttu-id="a7e4c-101">Dodaj następujące właściwości do `Movie` klasy:</span><span class="sxs-lookup"><span data-stu-id="a7e4c-101">Add the following properties to the `Movie` class:</span></span>
