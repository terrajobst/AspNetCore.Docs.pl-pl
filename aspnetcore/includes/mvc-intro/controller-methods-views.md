...
![Edytuj widok: wyjątek dla nieprawidłowej wartości cen ABC, stwierdzający, że pola Cena musi być liczbą. Wyjątek dla nieprawidłowej wartości Data wydania xyz stanów należy wprowadzić prawidłową datę.](~/tutorials/first-mvc-app/controller-methods-views/_static/val.png)
