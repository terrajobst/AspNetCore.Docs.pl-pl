<span data-ttu-id="89203-101">Uruchom Generator szkieletu tożsamości:</span><span class="sxs-lookup"><span data-stu-id="89203-101">Run the Identity scaffolder:</span></span>
