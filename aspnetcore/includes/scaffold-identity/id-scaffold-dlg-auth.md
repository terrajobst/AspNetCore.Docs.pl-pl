<span data-ttu-id="94221-101">Uruchom Generator szkieletu tożsamości:</span><span class="sxs-lookup"><span data-stu-id="94221-101">Run the Identity scaffolder:</span></span>
