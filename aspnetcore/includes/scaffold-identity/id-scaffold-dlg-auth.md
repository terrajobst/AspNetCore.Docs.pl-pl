<span data-ttu-id="60104-101">Uruchom Generator szkieletu tożsamości:</span><span class="sxs-lookup"><span data-stu-id="60104-101">Run the Identity scaffolder:</span></span>
