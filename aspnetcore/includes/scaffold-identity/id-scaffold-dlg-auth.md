<span data-ttu-id="ba875-101">Uruchom Generator szkieletu tożsamości:</span><span class="sxs-lookup"><span data-stu-id="ba875-101">Run the Identity scaffolder:</span></span>
