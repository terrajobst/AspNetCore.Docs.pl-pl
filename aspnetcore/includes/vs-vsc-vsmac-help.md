...
* [Dowiedz się, jak debugowanie C# kodu za pomocą programu Visual Studio](https://docs.microsoft.com/visualstudio/debugger/getting-started-with-the-debugger?view=vs-2017)
