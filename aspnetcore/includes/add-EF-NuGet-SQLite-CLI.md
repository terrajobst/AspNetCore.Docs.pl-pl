<span data-ttu-id="6fbea-101">Run the following .NET Core CLI commands:</span><span class="sxs-lookup"><span data-stu-id="6fbea-101">Run the following .NET Core CLI commands:</span></span>
