...
Aby użyć `IDistributedCache` interfejsu:
   ...
   3. Z poziomu aplikacji [oprogramowanie pośredniczące](../../fundamentals/middleware.md) lub klasy kontrolera MVC, żądania wystąpienia `IDistributedCache` z konstruktora. Wystąpienie, które będą udostępniane przez [iniekcji zależności](../../fundamentals/dependency-injection.md) (Podpisane).
