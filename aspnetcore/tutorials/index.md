...
## <a name="building-web-applications"></a>Tworzenie aplikacji sieci web
...
## <a name="building-web-apis"></a>Tworzenie interfejsów API sieci web
...
* [ASP.NET Core stron sieci Web interfejsu API pomocy przy użyciu programu Swagger](web-api-help-pages-using-swagger.md)
* [Tworzenie wewnętrznej bazy danych usługi sieci web do natywnych aplikacji dla urządzeń przenośnych](../mobile/native-mobile-backend.md)
...
* [Uwierzytelnianie dwuskładnikowe z programem SMS](../security/authentication/2fa.md)

## <a name="client-side-development"></a>Programowanie po stronie klienta
* [Przy użyciu Gulp](../client-side/using-gulp.md)
* [Przy użyciu Grunt](../client-side/using-grunt.md)
* [Zarządzaj pakietami po stronie klienta z Bower](../client-side/bower.md)
* [Tworzenie doskonałych, dynamiczne witryny z ładowania początkowego](../client-side/bootstrap.md)

## <a name="testing"></a>Testowanie
* [Testowanie jednostkowe w .NET Core za pomocą testu dotnet](https://docs.microsoft.com/dotnet/articles/core/testing/unit-testing-with-dotnet-test)

## <a name="publishing-and-deployment"></a>Publikowanie i wdrażanie
...
* [Publikowanie aplikacji sieci Web platformy Azure przy użyciu ciągłe wdrażanie](../publishing/azure-continuous-deployment.md)
