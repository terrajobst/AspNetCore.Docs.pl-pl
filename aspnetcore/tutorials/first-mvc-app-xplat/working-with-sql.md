...
> <span data-ttu-id="8a528-103">[Poprzednie — Dodaj model](adding-model.md)
> [dalej - metod kontrolera oraz widoków](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="8a528-103">[Previous - Add a model](adding-model.md)
