...
keywords: Platformy ASP.NET Core EF migracji
ms.author: riande
manager: wpickett
ms.date: 04/14/2017
...
<span data-ttu-id="6b3a4-104">[Poprzednie — Dodaj wyszukiwanie](search.md)
[następne — Dodawanie walidacji](validation.md)</span><span class="sxs-lookup"><span data-stu-id="6b3a4-104">[Previous - Add search](search.md)
