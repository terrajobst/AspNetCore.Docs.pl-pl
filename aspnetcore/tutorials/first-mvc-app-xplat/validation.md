...
> <span data-ttu-id="1ee52-103">[Poprzednie — Dodawanie pola](new-field.md)
> [obok - zbadać szczegóły i metody zostaną usunięte](xref:tutorials/first-mvc-app/details)</span><span class="sxs-lookup"><span data-stu-id="1ee52-103">[Previous - Add a field](new-field.md)
