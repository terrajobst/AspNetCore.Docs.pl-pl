...
> <span data-ttu-id="46754-103">[Poprzedni: Praca z SQLlite](xref:tutorials/razor-pages-mac/sql)
> [Dodaj wyszukiwania](xref:tutorials/razor-pages-mac/search)</span><span class="sxs-lookup"><span data-stu-id="46754-103">[Previous: Work with SQLlite](xref:tutorials/razor-pages-mac/sql)
