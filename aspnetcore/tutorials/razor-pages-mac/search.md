...
<span data-ttu-id="9f0e7-103">[Poprzedni: Aktualizowanie stron](xref:tutorials/razor-pages-mac/da1)
[dalej: dodanie nowego pola](xref:tutorials/razor-pages/new-field)</span><span class="sxs-lookup"><span data-stu-id="9f0e7-103">[Previous: Updating the pages](xref:tutorials/razor-pages-mac/da1)
