...
> <span data-ttu-id="4e3a7-103">[Poprzedni: Dodawanie modelu](xref:tutorials/razor-pages-vsc/model)
> [dalej: zaktualizować strony](xref:tutorials/razor-pages-vsc/da1)</span><span class="sxs-lookup"><span data-stu-id="4e3a7-103">[Previous: Adding a model](xref:tutorials/razor-pages-vsc/model)
