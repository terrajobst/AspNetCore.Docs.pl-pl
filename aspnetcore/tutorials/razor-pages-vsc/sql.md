...
> <span data-ttu-id="da86a-103">[Poprzedni: Dodawanie modelu](xref:tutorials/razor-pages-vsc/model)
> [dalej: aktualizowanie stron](xref:tutorials/razor-pages-vsc/da1)</span><span class="sxs-lookup"><span data-stu-id="da86a-103">[Previous: Adding a model](xref:tutorials/razor-pages-vsc/model)
