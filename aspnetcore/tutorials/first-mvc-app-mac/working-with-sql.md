...
> <span data-ttu-id="bca25-103">[Poprzednie — Dodaj model](adding-model.md)
> [dalej - metod kontrolera oraz widoków](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="bca25-103">[Previous - Add a model](adding-model.md)
