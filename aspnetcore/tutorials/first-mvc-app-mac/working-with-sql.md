...
ms.locfileid: "36960882"
---
[!INCLUDE [adding-model](../../includes/mvc-intro/sql.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="a5ddb-103">[Poprzednie — Dodaj model](adding-model.md)
> [dalej - metod kontrolera oraz widoków](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="a5ddb-103">[Previous - Add a model](adding-model.md)
