...
- Kliknij prawym przyciskiem myszy folder `publish` i wybierz pozycję `Deploy to Web App...`
...
Po kliknięciu `Browse Website` przejdziesz do niego za pomocą domyślnej przeglądarki:
...
Rozszerzenie spowoduje wdrożenie zaktualizowanej zawartości w aplikacji sieci Web. Po zakończeniu kliknij pozycję `Browse Website`, aby sprawdzić poprawność wdrożenia.
