...
Tej serii samouczków pokazano, jak utworzyć gRPC usługi programu ASP.NET Core. Dowiedz się, jak utworzyć projekt usługi gRPC, Edytuj plik proto i dodać dupleks przesyłania strumieniowego wywołania.

Ta seria zawiera następujące samouczki:

1. [Utwórz gRPC Greeter usługi](xref:tutorials/grpc/grpc-start)
2. [Tworzenie klienta gRPC platformy .NET Core](xref:tutorials/grpc/grpc-client)
