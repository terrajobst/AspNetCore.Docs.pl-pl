...
Jeśli plik projektu zawiera `<RuntimeFrameworkVersion>1.{sub-version}</RuntimeFrameworkVersion>`, zobacz [ten problem](https://github.com/aspnet/AspNetCore/issues/3221#issuecomment-413094268)w usłudze GitHub.
