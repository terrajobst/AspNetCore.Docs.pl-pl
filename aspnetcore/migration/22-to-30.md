...
Oprócz włączania `AllowSynchronousIO` z opcjami `ConfigureKestrel`synchroniczne operacje we/wy mogą być również zastępowane dla poszczególnych żądań jako tymczasowe środki zaradcze:
