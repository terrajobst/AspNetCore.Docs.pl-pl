...
Aby uzyskać więcej informacji, zobacz temat <xref:host-and-deploy/aspnet-core-module#hosting-models>.
...
Aby uzyskać więcej informacji, zobacz temat <xref:fundamentals/metapackage-app>.
...
Aby uzyskać więcej informacji, zobacz temat <xref:fundamentals/servers/kestrel#how-to-use-kestrel-in-aspnet-core-apps>.
