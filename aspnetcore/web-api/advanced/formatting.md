...
### <a name="forcing-a-particular-format"></a><span data-ttu-id="7e1df-186">Wymuszanie w określonym formacie</span><span class="sxs-lookup"><span data-stu-id="7e1df-186">Forcing a Particular Format</span></span>
